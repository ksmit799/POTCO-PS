...
class NameTumbler(DirectFrame):
    ...
    def makeScrollList(self, nitems, nitemMakeFunction, nitemMakeExtraArgs):
        it = nitems[:]
        ds = DirectScrolledList(items = it, itemMakeFunction = nitemMakeFunction, itemMakeExtraArgs = nitemMakeExtraArgs, parent = aspect2d, relief = None, command = None, scale = 0.59999999999999998, pad = (0.10000000000000001, 0.10000000000000001), incButton_image = (self.downArrow, self.upArrow, self.circle, self.downArrow), incButton_relief = None, incButton_scale = (0.20000000000000001, 0.050000000000000003, 0.050000000000000003), incButton_pos = (0, 0, -0.57999999999999996), decButton_image = (self.upArrow, self.downArrow, self.circle, self.upArrow), decButton_relief = None, decButton_scale = (0.20000000000000001, 0.050000000000000003, 0.050000000000000003), decButton_pos = (0, 0, 0.23000000000000001), itemFrame_pos = (-0.20000000000000001, 0, 0.028000000000000001), itemFrame_scale = 1.0, itemFrame_relief = None, itemFrame_image = self.background, itemFrame_image_scale = (0.38, 0, 0.33000000000000002), itemFrame_image_pos = (0.20000000000000001, 0, -0.20000000000000001), itemFrame_frameSize = (-0.050000000000000003, 0.47999999999999998, -0.5, 0.10000000000000001), itemFrame_borderWidth = (0.01, 0.01), numItemsVisible = 5)
    ...
    def makeHighlight(self, npos):
        return DirectFrame(parent = aspect2d, relief = 'flat', state = 'disabled', frameSize = (-0.25, 0.26000000000000001, -0.050000000000000003, 0.050000000000000003), borderWidth = (0.01, 0.01), pos = npos, frameColor = (1, 0, 1, 0.40000000000000002))
