...
class OTPDialog(DirectDialog):
    ...
    def __init__(self, parent = None, style = NoButtons, **kw):
        ...
        optiondefs = (('buttonImageList', buttonImage, DGG.INITOPT), ('buttonTextList', buttonText, DGG.INITOPT), ('buttonValueList', buttonValue, DGG.INITOPT), ('buttonPadSF', 2.2000000000000002, DGG.INITOPT), ('text_font', DGG.getDefaultFont(), None), ('text_wordwrap', 12, None), ('text_scale', 0.070000000000000007, None), ('buttonSize', (-0.050000000000000003, 0.050000000000000003, -0.050000000000000003, 0.050000000000000003), None), ('button_pad', (0, 0), None), ('button_relief', None, None), ('button_text_pos', (0, -0.10000000000000001), None), ('fadeScreen', 0.5, None), ('image_color', OTPGlobals.GlobalDialogColor, None))
