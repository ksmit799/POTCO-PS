...
HullDict = {
    ...
    ShipGlobals.BRIGL1: 'models/shipparts/brigMeter',
    ShipGlobals.BRIGL2: 'models/shipparts/brigMeter',
    ShipGlobals.BRIGL3: 'models/shipparts/brigMeter',
    ShipGlobals.BLACK_PEARL: 'models/shipparts/brigMeter',
    ShipGlobals.GOLIATH: 'models/shipparts/brigMeter',
    ShipGlobals.SHIP_OF_THE_LINE: 'models/shipparts/brigMeter',
    ShipGlobals.QUEEN_ANNES_REVENGE: 'models/shipparts/brigMeter',
