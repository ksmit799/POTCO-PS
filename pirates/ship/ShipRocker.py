from pirates.util.PythonUtil import rad90, rad270, reduceAngle
#from pirates.util.PythonUtilPOD import pivotScalar
import math
...
class ShipRocker:
    ...
    def addRoll(self, roll):
        ...
        newRoll = 0.10000000000000001 * curRollTarget + roll
        newRoll = clampScalar(newRoll, self._maxRoll, -(self._maxRoll))
        impactDur = 0.050000000000000003 * abs(newRoll - curRoll) * self._fakeMass
