...
ShipModelClass2CameraParams = {
    ...
    ShipGlobals.BRIGL1: CamParams(idealDistance = 350.0, autoFaceForward = True, minDistance = 150.0, maxDistance = 800.0, lookAtOffset = Vec3(0, 0, 40)),
    ShipGlobals.BRIGL2: CamParams(idealDistance = 600.0, autoFaceForward = True, minDistance = 200.0, maxDistance = 1285.0, lookAtOffset = Vec3(0, 0, 60)),
    ShipGlobals.BRIGL3: CamParams(idealDistance = 700.0, autoFaceForward = True, minDistance = 250.0, maxDistance = 1650.0, lookAtOffset = Vec3(0, 0, 80)),
