...
class GameFSMShip(FSM.FSM):
    ...
    enterClientSteering = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'shipboard')(enterClientSteering)
    ...
    exitClientSteering = report(types = [
        'frameCount',
        'deltaStamp',
        'args'], dConfigParam = 'shipboard')(exitClientSteering)
    ...
    def initAudio(self):
        ...
        base.musicMgr.request(self.currentMusic, priority = 0, volume = 0.59999999999999998)
