...
class DistributedGhost(DistributedBattleNPC.DistributedBattleNPC, Ghost.Ghost):
    ...
    def play(self, *args, **kwArgs):
        Ghost.Ghost.play(self, *args, **args)

    
    def loop(self, *args, **kwArgs):
        Ghost.Ghost.loop(self, *args, **args)

    
    def pose(self, *args, **kwArgs):
        Ghost.Ghost.pose(self, *args, **args)

    
    def pingpong(self, *args, **kwArgs):
        Ghost.Ghost.pingpong(self, *args, **args)

    
    def stop(self, *args, **kwArgs):
        Ghost.Ghost.stop(self, *args, **args)
