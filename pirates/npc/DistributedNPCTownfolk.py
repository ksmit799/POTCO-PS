...
class DistributedNPCTownfolk(DistributedBattleNPC.DistributedBattleNPC, DistributedShopKeeper.DistributedShopKeeper, Townfolk.Townfolk):
    ...
    def computeOptions(self):
        ...
        if avFishingLevel < 10 and localAvatar.onWelcomeWorld or config.GetBool('disable-fishing-boats', 0):
        ...
        buttonStateDict = {
            ...
            InteractGlobals.OVERHAUL: overhaulButtonState,
            InteractGlobals.UPGRADE: upgradeButtonState,
