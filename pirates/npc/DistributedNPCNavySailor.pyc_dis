...
class DistributedNPCNavySailor(DistributedBattleNPC.DistributedBattleNPC, NavySailor.NavySailor):
    ...
    def play(self, *args, **kwArgs):
        NavySailor.NavySailor.play(self, *args, **args)

    
    def loop(self, *args, **kwArgs):
        NavySailor.NavySailor.loop(self, *args, **args)

    
    def pose(self, *args, **kwArgs):
        NavySailor.NavySailor.pose(self, *args, **args)

    
    def pingpong(self, *args, **kwArgs):
        NavySailor.NavySailor.pingpong(self, *args, **args)

    
    def stop(self, *args, **kwArgs):
        NavySailor.NavySailor.stop(self, *args, **args)
