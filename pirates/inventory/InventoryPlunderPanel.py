...
class InventoryPlunderPanel(DirectFrame):
    ...
    def __init__(self, manager, plunderList, rating, typeName, itemsToTake, customName, timer = 0, autoShow = False):
        ...
        optiondefs = (('relief', None, None), ('state', DGG.DISABLED, None), ('image', gui.find('**/main_gui_quest_scroll'), None), ('image_pos', (0.5, 0.0, 0.45000000000000001), None), ('image_scale', (0.5, 1.0, 0.75), None), ('frameSize', (-0.0 * self.sizeX, 1.0 * self.sizeX, -0.0 * self.sizeZ, 1.0 * self.sizeZ), None))
