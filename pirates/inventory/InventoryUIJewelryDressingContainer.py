        ...
        for cell in self.cellList:
            ...
            if cell.slotId != None:
                if cell.slotId in Locations.RANGE_EQUIP_R_EYEBROW_JEWELRY:
                    ...
                    scale = self.imageScale * self.cellSizeX * 0.59999999999999998
                    ...
                    scale = self.imageScale * self.cellSizeX * 1.3999999999999999
                elif cell.slotId in Locations.RANGE_EQUIP_R_FINGER_JEWELRY:
                    jewelryIcon = jewelerGui.find('**/icon_shop_jeweler_ring')
                    scale = self.imageScale * self.cellSizeX * 0.80000000000000004
                    flip = 1
