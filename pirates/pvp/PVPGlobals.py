...
ShipClass2repairLocators = {
    ...
    ShipGlobals.WARSHIPL3: StateVarSetting(repairSpotNamePrefix + 'warshipL3', [
        ...
        2,
        3]),
    ShipGlobals.BRIGL1: StateVarSetting(repairSpotNamePrefix + 'brigL1', [
        0,
        1,
        2,
        3]),
    ShipGlobals.BRIGL2: StateVarSetting(repairSpotNamePrefix + 'brigL2', [
        0,
        1,
        2,
        3]),
    ShipGlobals.BRIGL3: StateVarSetting(repairSpotNamePrefix + 'brigL3', [
        0,
        1,
        2,
        3]),
    ...
    ShipGlobals.HUNTER_VENGEANCE: StateVarSetting(repairSpotNamePrefix + 'hunterVengeance', []),
...
TeamBalanceValues.Ships = {
    ...
    ShipGlobals.BRIGL1: 14,
    ShipGlobals.BRIGL2: 16,
    ShipGlobals.BRIGL3: 23,
...
RenownWorthValues = {
    ...
    ShipGlobals.BRIGL1: 5,
    ShipGlobals.BRIGL2: 8,
    ShipGlobals.BRIGL3: 10,
