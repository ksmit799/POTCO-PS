...
class ShipStoreGUI(GuiPanel.GuiPanel):
    ...
    ShipIconTable = {
        ...
        ItemId.SHIP_OF_THE_LINE: 'Catalog_War_Brig',
        ...
        ItemId.HUNTER_VENGEANCE: 'Catalog_War_Brig',
    ...
    def updateProfile(self):
        ...
        self.shipImage['image_scale'] = (0.27000000000000002, 1.0, 0.19)
        self.updateStats()
        self.shipStats.refreshBars(self.statData)
        self.updateBalance()
        if not Freebooter.getPaidStatus(base.localAvatar.getDoId()):
            if self.purchaseInventory[0][0] not in [
                ItemId.INTERCEPTOR_L1,
                ItemId.MERCHANT_L1,
                ItemId.WARSHIP_L1,
                ItemId.BRIG_L1]:
