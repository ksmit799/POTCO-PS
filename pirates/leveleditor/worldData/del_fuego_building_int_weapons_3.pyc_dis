        ...
        '1233252736.0akelts6': {
            ...
            'Objects': {
                '1157098184.94jasyeung': {
                    ...
                    'Hpr': VBase3(122.36499999999999, 0.0, 0.0),
                    'Patrol Radius': '12.0000',
                    'Pos': Point3(32.932000000000002, 11.391, 0.0),
                    'PoseAnim': '',
                    'PoseFrame': '',
                    'Private Status': 'All',
                    'Respawns': True,
                ...
                '1223919703.7akelts': {
                    ...
                    'Pos': Point3(0.40999999999999998, -5.6219999999999999, 0.91200000000000003),
                    'Scale': VBase3(1.0, 1.0, 1.0) },
                '1223919704.8akelts': {
                    'Type': 'Door Locator Node',
                    'Name': 'door_locator_2',
                    'Hpr': Point3(0.0, 0.0, 0.0),
                    'Pos': Point3(6.9729999999999999, 21.236999999999998, 1.0389999999999999),
                    'Scale': VBase3(1.0, 1.0, 1.0) },
                '1223919722.81akelts': {
                    'Type': 'Light - Dynamic',
                    'Attenuation': '0.005',
                    ...
                    'Intensity': '0.1446',
                    'LightType': 'AMBIENT',
                    'Pos': Point3(14.195, -6.9660000000000002, 33.045000000000002),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'VisSize': '',
                    'Visual': {
                        'Color': (1, 1, 1, 1),
                ...
                '1223919741.19akelts': {
                    ...
                    'DropOff': '0.0000',
                    'FlickRate': '0.5000',
                    'Hpr': VBase3(0.0, -88.417000000000002, 0.0),
                    'Intensity': '0.1446',
                    'LightType': 'DIRECTIONAL',
                    'Pos': Point3(563.72900000000004, -1197.2429999999999, 71.281000000000006),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'VisSize': '',
                    'Visual': {
                        'Color': (0.90000000000000002, 0.94999999999999996, 1.0, 1.0),
                        'Model': 'models/props/light_tool_bulb' } },
                '1223919787.95akelts': {
                    'Type': 'Light - Dynamic',
                    'Attenuation': '0.005',
                    ...
                    'Intensity': '0.7229',
                    'LightType': 'POINT',
                    'Pos': Point3(555.08399999999995, -1187.883, 39.572000000000003),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'VisSize': '',
                    'Visual': {
                        'Color': (1.0, 0.85999999999999999, 0.77000000000000002, 1.0),
                        'Model': 'models/props/light_tool_bulb' } } },
            'VisSize': '',
            'Visual': {
