        ...
        '1141410776.53sdnaik': {
            ...
            'Objects': {
                '1135280776.06dzlu': {
                    ...
                    'Objects': {
                        '1141788542.31sdnaik': {
                            ...
                            'Pos': Point3(-6.2919999999999998, -135.71000000000001, 123.133),
                            'Radi': [
                                1055,
                                1355,
                                1655],
                        ...
                        '1146285188.25jubutler': {
                            ...
                            'Hpr': Point3(0.0, 0.0, 0.0),
                            'Objects': { },
                            'Pos': Point3(-55.951000000000001, 266.14100000000002, 0.0),
                            'Scale': VBase3(1.0, 1.0, 1.0) } },
                    'Pos': Point3(-43.875999999999998, 266.48599999999999, -0.002),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Visual': {
                ...
                '1142029312.31sdnaik': {
                    ...
                    'Hpr': Point3(0.0, 0.0, 0.0),
                    'Level': '3',
                    'Pos': Point3(-279.97399999999999, -4300.9949999999999, 0.0),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Spawnables': 'Warship',
                    'Team': '1' },
                '1142029640.48sdnaik': {
                    ...
                    'Hpr': Point3(0.0, 0.0, 0.0),
                    'Level': '3',
                    'Pos': Point3(551.44200000000001, -6648.3159999999998, 0.0),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Spawnables': 'Warship',
                    'Team': '1' },
                '1142029643.17sdnaik': {
                    'Type': 'Ship Movement Node',
                    'Hpr': Point3(0.0, 0.0, 0.0),
                    'Pos': Point3(2388.2339999999999, -4901.1459999999997, 0.0),
                    'Scale': VBase3(1.0, 1.0, 1.0) },
                '1142029649.52sdnaik': {
                    'Type': 'Ship Spawn Node',
                    'Flagship': False,
                    'Hpr': Point3(0.0, 0.0, 0.0),
                    'Level': '3',
                    'Pos': Point3(1319.8230000000001, -1769.396, 0.0),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Spawnables': 'Warship',
                    'Team': '1' },
                '1142029656.11sdnaik': {
                ...
                '1146605142.08jubutler': {
                    ...
                    'Hpr': Point3(0.0, 0.0, 0.0),
                    'Level': '2',
                    'Pos': Point3(4953.6899999999996, -693.755, 0.0),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Spawnables': 'Merchant',
                    'Team': '2' },
                '1146605151.81jubutler': {
                    ...
                    'Hpr': Point3(0.0, 0.0, 0.0),
                    'Level': '2',
                    'Pos': Point3(-2873.576, -6131.7730000000001, 0.0),
                    'Scale': VBase3(1.0, 1.0, 1.0),
                    'Spawnables': 'Merchant',
                    'Team': '2' } } } },
    'Node Links': [
