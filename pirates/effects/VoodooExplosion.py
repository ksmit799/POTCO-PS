...
class VoodooExplosion(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(0.0, 0.0, 0.0, 1.0), Vec4(0.20000000000000001, 0.10000000000000001, 0.59999999999999998, 0.40000000000000002), 1)
        ...
        self.p1.renderer.setInitialXScale(0.0030000000000000001 * self.cardScale)
        self.p1.renderer.setFinalXScale(0.025000000000000001 * self.cardScale)
        self.p1.renderer.setInitialYScale(0.0030000000000000001 * self.cardScale)
        ...
        self.p1.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(1.0, 1.0, 1.0, 0.20000000000000001), Vec4(0.75, 0.59999999999999998, 1.0, 0), 1)
    ...
    def setEffectColor(self, color):
        ...
        self.p1.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(1.0, 1.0, 1.0, 0.20000000000000001), self.effectColor - Vec4(0, 0, 0, 1), 1)
