...
class BurpEffect(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        temp.detachNode()
        skullFadeIn = self.icon.colorScaleInterval(2.0, Vec4(0.10000000000000001, 0.10000000000000001, 0, 0.34999999999999998), startColorScale = Vec4(0, 0, 0, 0))
        skullFadeOut = self.icon.colorScaleInterval(1.0, Vec4(0, 0, 0, 0), startColorScale = Vec4(0.10000000000000001, 0.10000000000000001, 0, 0.34999999999999998))
        skullScaleUp = self.icon.scaleInterval(4.0, 3.0, startScale = 0.10000000000000001, blendType = 'easeOut')
