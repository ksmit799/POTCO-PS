...
class Sparks(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        self.p0.renderer.setFinalXScale(0.0040000000000000001 * self.cardScale)
        ...
        self.startEffect = Sequence(Func(self.p0.setBirthRate, 0.0050000000000000001), Func(self.p0.setPoolSize, 32.0), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self))
