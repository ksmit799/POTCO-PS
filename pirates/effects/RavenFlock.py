...
class RavenFlock(PooledEffect, EffectController):
    ...
    def __init__(self, parent = None):
        ...
        force0.setActive(1)
        f0.addForce(force0)
        force1 = LinearSinkForce(Point3(0.0, 0.0, 0.0), LinearDistanceForce.FTONEOVERRSQUARED, 1.0, 0.050000000000000003, 0)
        ...
        self.p1.renderer.setInitialXScale(0.40000000000000002)
        self.p1.renderer.setFinalXScale(0.40000000000000002)
        self.p1.renderer.setInitialYScale(0.40000000000000002)
        self.p1.renderer.setFinalYScale(0.40000000000000002)
        ...
        self.p2.renderer.setInitialXScale(0.20000000000000001)
        self.p2.renderer.setFinalXScale(0.20000000000000001)
        self.p2.renderer.setInitialYScale(0.20000000000000001)
        self.p2.renderer.setFinalYScale(0.20000000000000001)
