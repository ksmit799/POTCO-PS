...
class CraterSmoke(PooledEffect, EffectController):
    ...
    def createTrack(self, lod = None):
        ...
        self.p0.renderer.setColor(Vec4(0.80000000000000004, 0.80000000000000004, 1.0, 1.0))
        ...
        self.p1.renderer.setInitialXScale(0.20000000000000001 * self.cardScale)
        self.p1.renderer.setFinalXScale(0.5 * self.cardScale)
        self.p1.renderer.setInitialYScale(0.20000000000000001 * self.cardScale)
        ...
        self.p1.renderer.getColorInterpolationManager().addLinear(0.10000000000000001, 1.0, Vec4(1.0, 1.0, 1.0, 1.0), Vec4(1.0, 1.0, 1.0, 0.0), 1)
