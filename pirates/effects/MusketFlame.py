...
class MusketFlame(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        self.p0.factory.setLifespanBase(0.10000000000000001)
        self.p0.factory.setLifespanSpread(0.050000000000000003)
        self.p0.factory.setMassBase(0.5)
        self.p0.factory.setMassSpread(0.29999999999999999)
        ...
        self.p0.renderer.setInitialXScale(0.059999999999999998 * self.cardScale)
        self.p0.renderer.setFinalXScale(0.02 * self.cardScale)
        self.p0.renderer.setInitialYScale(0.059999999999999998 * self.cardScale)
        ...
        fadeBlast = self.flash.colorScaleInterval(0.14999999999999999, Vec4(0, 0, 0, 0), startColorScale = self.startCol, blendType = 'easeOut')
        scaleBlast = self.flash.scaleInterval(0.20000000000000001, 10, blendType = 'easeIn')
        ...
        self.playParticles = Sequence(Func(self.p0.setBirthRate, 0.01), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self), Wait(0.14999999999999999), Func(self.p0.setBirthRate, 100), Wait(1.5), Func(self.cleanUpEffect))
