...
class JRSpawn(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        fadeInRays = LerpColorScaleInterval(self.rays, 1.0, VBase4(0.80000000000000004, 1, 0.10000000000000001, 1), startColorScale = VBase4(0.80000000000000004, 1, 0.10000000000000001, 0))
        fadeOutRays = LerpColorScaleInterval(self.rays, 2.0, VBase4(0.80000000000000004, 1, 0.10000000000000001, 0), startColorScale = VBase4(0.80000000000000004, 1, 0.10000000000000001, 1))
        scaleUpRays = LerpScaleInterval(self.rays, 2.0, VBase3(1, 1, 1.5), startScale = VBase3(0.5, 0.5, 0.20000000000000001), blendType = 'easeInOut')
        scaleDownRays = LerpScaleInterval(self.rays, 2.0, VBase3(0.5, 0.5, 0.20000000000000001), startScale = VBase3(1, 1, 1.5), blendType = 'easeInOut')
