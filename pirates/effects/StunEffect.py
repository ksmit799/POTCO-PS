...
class StunEffect(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        self.p0.renderer.setFinalXScale(0.0060000000000000001 * self.cardScale * self.effectScale)
        ...
        self.startEffect = Sequence(Func(self.p0.clearToInitial), Func(self.p0.setBirthRate, 0.20000000000000001), Func(self.f.start, self, self.dummy2), Func(rotate.loop), Func(rotateH.loop))
