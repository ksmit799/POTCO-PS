...
class ToxinEffect(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(0.80000000000000004, 0.59999999999999998, 1, 1), Vec4(0.20000000000000001, 0.10000000000000001, 0.25, 0.5), 1)
    ...
    def createTrack(self):
        ...
        self.p0.renderer.setFinalXScale(0.050000000000000003 * self.cardScale * self.effectScale)
        self.p0.renderer.setInitialYScale(0.001 * self.cardScale * self.effectScale)
        self.p0.renderer.setFinalYScale(0.040000000000000001 * self.cardScale * self.effectScale)
