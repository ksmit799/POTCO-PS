...
class SparkBurst(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.emitter.setOffsetForce(Vec3(1.0, 1.0, -0.10000000000000001))
        self.p0.emitter.setExplicitLaunchVector(Vec3(0.10000000000000001, 0.0, 100.0))
    ...
    def createTrack(self, color = 'Yellow'):
        ...
        if color == 'Dark':
            self.p0.renderer.setInitialXScale(0.0050000000000000001 * self.darkCardScale)
            self.p0.renderer.setFinalXScale(0.0001 * self.darkCardScale)
            self.p0.renderer.setInitialYScale(0.0050000000000000001 * self.darkCardScale)
            ...
            self.p0.renderer.setFinalXScale(1.0000000000000001e-005 * self.darkCardScale)
            self.p0.renderer.setInitialYScale(0.0015 * self.darkCardScale)
            self.p0.renderer.setFinalYScale(1.0000000000000001e-005 * self.darkCardScale)
