...
class FuseSparks(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.sparks2.setScale(0.59999999999999998)
    ...
    def createTrack(self):
        scaleFlashUp = LerpScaleInterval(self.flash, 0.10000000000000001, 1.1000000000000001, startScale = 0.80000000000000004)
        scaleFlashDown = LerpScaleInterval(self.flash, 0.14999999999999999, 0.80000000000000004, startScale = 1.3)
