...
class RainMist(EffectController, NodePath):
    ...
    def __init__(self, reference = None):
        ...
        self.p0.renderer.setInitialYScale(0.59999999999999998 * self.cardScale)
        ...
        self.p0.emitter.setExplicitLaunchVector(Vec3(0.20000000000000001, 0.0, 6.0))
    ...
    def createTrack(self):
        self.p0.renderer.setColor(Vec4(0.80000000000000004, 0.80000000000000004, 1.0, 0.25))
