...
class Fireflies(EffectController, NodePath):
    ...
    def createTrack(self):
        ...
        self.p0.renderer.setInitialXScale(0.0012999999999999999 * self.cardScale)
        self.p0.renderer.setFinalXScale(0.0012999999999999999 * self.cardScale)
        self.p0.renderer.setInitialYScale(0.0012999999999999999 * self.cardScale)
        self.p0.renderer.setFinalYScale(0.0012999999999999999 * self.cardScale)
