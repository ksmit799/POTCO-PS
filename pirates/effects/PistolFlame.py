...
class PistolFlame(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        self.p0.factory.setMassBase(0.69999999999999996)
        self.p0.factory.setMassSpread(0.59999999999999998)
        ...
        self.p0.renderer.setInitialXScale(0.040000000000000001 * self.cardScale)
