...
class SmallSplash(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.setInitialXScale(0.029999999999999999 * self.cardScale)
        self.p0.renderer.setFinalXScale(0.29999999999999999 * self.cardScale)
        self.p0.renderer.setInitialYScale(0.029999999999999999 * self.cardScale)
    ...
    def createTrack(self):
        ...
        self.track = Sequence(Func(playSplashSfx), Func(self.p0.setBirthRate, 0.14999999999999999), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self), Wait(0.29999999999999999), Func(self.p0.setBirthRate, 100), Wait(4.0), Func(self.cleanUpEffect))
