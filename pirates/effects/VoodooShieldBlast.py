...
class VoodooShieldBlast(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(0, 0.20000000000000001, 1, 0.80000000000000004), Vec4(0.80000000000000004, 0.90000000000000002, 1, 0), 1)
