...
class FlashStar(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        anim1 = Sequence(Wait(0.050000000000000003), Parallel(ray1Fadein, ray1Fadeout))
        anim2 = Sequence(Wait(0.10000000000000001), Parallel(ray2Fadein, ray2Fadeout))
        anim3 = Sequence(Wait(0.14999999999999999), Parallel(ray3Fadein, ray3Fadeout))
        anim4 = Sequence(Wait(0.20000000000000001), Parallel(ray4Fadein, ray4Fadeout))
        anim5 = Sequence(Wait(0.34999999999999998), Parallel(ray1Fadein, ray1Fadeout))
        anim6 = Sequence(Wait(0.40000000000000002), Parallel(ray2Fadein, ray2Fadeout))
        anim7 = Sequence(Wait(0.45000000000000001), Parallel(ray3Fadein, ray3Fadeout))
