...
class VoodooAuraDisc(PooledEffect, EffectController):
    ...
    def createTrack(self, lod = None):
        self.startEffect = Sequence(Func(self.p0.setBirthRate, 0.10000000000000001), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self))
