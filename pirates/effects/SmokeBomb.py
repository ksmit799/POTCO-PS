...
class SmokeBomb(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.setColor(Vec4(0.80000000000000004, 0.80000000000000004, 0.80000000000000004, 1.0))
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 0.80000000000000004, Vec4(0.75, 0.75, 0.75, 1.0), Vec4(0.40000000000000002, 0.40000000000000002, 0.20000000000000001, 0.5), 1)
        self.p0.renderer.getColorInterpolationManager().addLinear(0.80000000000000004, 1.0, Vec4(0.40000000000000002, 0.40000000000000002, 0.20000000000000001, 0.5), Vec4(0.0, 0.0, 0.0, 0.0), 1)
