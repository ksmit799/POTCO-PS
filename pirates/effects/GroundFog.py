...
class GroundFog(EffectController, NodePath):
    ...
    def createTrack(self, lod = Options.SpecialEffectsHigh):
        if lod >= Options.SpecialEffectsHigh:
            ...
            self.p0.setBirthRate(0.025000000000000001)
        ...
        self.p0.renderer.setFinalYScale(0.052999999999999999 * self.cardScale)
        self.p0.renderer.setNonanimatedTheta(0.0)
        self.p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPBLENDLINEAR)
        self.p0.renderer.setAlphaDisable(0)
        self.p0.renderer.getColorInterpolationManager().addConstant(0.0, 1.0, Vec4(0.59999999999999998, 0.80000000000000004, 1.0, 0.5), 1)
