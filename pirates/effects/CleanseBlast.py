...
class CleanseBlast(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.setColor(Vec4(1, 1, 1, 0.80000000000000004))
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.5, 1.0, Vec4(1, 1, 1, 1), Vec4(1, 0.90000000000000002, 0.5, 1), 1)
