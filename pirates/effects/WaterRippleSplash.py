...
class WaterRippleSplash(PooledEffect, EffectController):
    ...
    def __init__(self, parent = None):
        ...
        self.p1.renderer.setInitialXScale(0.014999999999999999 * self.cardScale)
        self.p1.renderer.setFinalXScale(0.0050000000000000001 * self.cardScale)
        self.p1.renderer.setInitialYScale(0.0050000000000000001 * self.cardScale)
        ...
        self.p1.renderer.getColorInterpolationManager().addLinear(0.59999999999999998, 1.0, Vec4(1.0, 1.0, 1.0, 1.0), Vec4(1.0, 1.0, 1.0, 0.0), 1)
