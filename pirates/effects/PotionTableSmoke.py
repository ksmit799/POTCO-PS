...
class PotionTableSmoke(PooledEffect, EffectController):
    ...
    def __init__(self, parent = None):
        ...
        self.p0.factory.setLifespanBase(2.1000000000000001)
    ...
    def setEffectScale(self, scale):
        self.p0.renderer.setInitialXScale(0.014999999999999999 * self.cardScale * scale)
        ...
        self.p0.renderer.setFinalYScale(0.10000000000000001 * self.cardScale * scale)
