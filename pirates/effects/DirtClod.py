...
class DirtClod(PooledEffect, EffectController):
    ...
    def createTrack(self):
        ...
        self.p0.factory.setMassBase(0.29999999999999999)
        self.p0.factory.setMassSpread(0.050000000000000003)
        ...
        self.p0.renderer.setFinalXScale(0.070000000000000007 * self.cardScale)
        self.p0.renderer.setInitialYScale(0.040000000000000001 * self.cardScale)
        self.p0.renderer.setFinalYScale(0.070000000000000007 * self.cardScale)
        ...
        self.track = Sequence(Func(self.p0.setBirthRate, 0.029999999999999999), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy), Func(self.f.reparentTo, self), Wait(0.10000000000000001), Func(self.p0.setBirthRate, 100), Wait(3.0), Func(self.cleanUpEffect))
