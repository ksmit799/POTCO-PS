...
class RayOfLight(NodePath, EffectController):
    ...
    def createTrack(self):
        ...
        startBottomEffect = report(types = [
            'args'], dConfigParam = 'quest-indicator')(startBottomEffect)
        ...
        stopBottomEffect = report(types = [
            'args'], dConfigParam = 'quest-indicator')(stopBottomEffect)
    ...
    createTrack = report(types = [
        'args'], dConfigParam = 'quest-indicator')(createTrack)
    ...
    startAdjustTask = report(types = [
        'args'], dConfigParam = 'quest-indicator')(startAdjustTask)
    ...
    stopAdjustTask = report(types = [
        'args'], dConfigParam = 'quest-indicator')(stopAdjustTask)
    ...
    adjustTask = report(types = [
        'args'], dConfigParam = 'quest-indicator')(adjustTask)
