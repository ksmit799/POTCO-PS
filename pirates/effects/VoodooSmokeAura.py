...
class VoodooSmokeAura(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.setColor(Vec4(0.80000000000000004, 0.80000000000000004, 0.80000000000000004, 0.59999999999999998))
        self.p0.renderer.setXScaleFlag(1)
        self.p0.renderer.setYScaleFlag(1)
        self.p0.renderer.setAnimAngleFlag(0)
        self.p0.renderer.setInitialXScale(0.025000000000000001 * self.cardScale)
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 0.20000000000000001, Vec4(0, 0, 0, 0), Vec4(1.0, 0.40000000000000002, 0.40000000000000002, 1), 1)
        self.p0.renderer.getColorInterpolationManager().addLinear(0.20000000000000001, 1.0, Vec4(1.0, 0.40000000000000002, 0.40000000000000002, 1.0), Vec4(0, 0, 0, 1), 1)
    ...
    def createTrack(self):
        self.startEffect = Sequence(Func(self.p0.setBirthRate, 0.025000000000000001), Func(self.p0.clearToInitial), Func(self.f.start, self, self.particleDummy))
