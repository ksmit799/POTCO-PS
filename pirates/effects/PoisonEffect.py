...
class PoisonEffect(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.0, 1.0, Vec4(0.40000000000000002, 1, 0.29999999999999999, 1), Vec4(0, 0, 0, 0.25), 1)
    ...
    def createTrack(self):
        self.p0.renderer.setInitialXScale(0.00050000000000000001 * self.cardScale * self.effectScale)
        self.p0.renderer.setFinalXScale(0.059999999999999998 * self.cardScale * self.effectScale)
        self.p0.renderer.setInitialYScale(0.00050000000000000001 * self.cardScale * self.effectScale)
