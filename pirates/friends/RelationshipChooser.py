...
class RelationshipChooser(GuiPanel.GuiPanel):
    ...
    def __init__(self, avId, avName, pId = None):
        ...
        self.setPos(0.14999999999999999, 0, 0.25)
        self.chain = PirateButtonChain.PirateButtonChain(self.width, self)
        self.chain.setPos(0, 0, -0.029999999999999999)
        self.load()
    ...
    def load(self):
        ...
        self.plFriendButton = self.chain.premakeButton(PLocalizer.RelationshipChooserPlFriendsMake, self._RelationshipChooser__handlePlayerFriend)
    ...
    def _RelationshipChooser__handlePlayerFriend(self):
