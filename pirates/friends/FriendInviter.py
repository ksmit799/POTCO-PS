...
class FriendInviter(DirectFrame):
    ...
    def __init__(self, avId, avName, isPlayerInvite, quickYesNo = True, playerId = None):
        ...
        DirectFrame.__init__(self, relief = None, pos = (-0.25, 0, 0.64000000000000001), image = guiMain.find('**/general_frame_e'), image_scale = 0.34999999999999998)
        ...
        self.title = DirectLabel(parent = self, relief = None, text = PLocalizer.FriendInviterTitle, text_scale = PiratesGuiGlobals.TextScaleLarge * 1.8, text_align = TextNode.ACenter, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_font = PiratesGlobals.getPirateOutlineFont(), pos = (0.0, 0, 0.20000000000000001), image = None, image_scale = 1.0)
        self.message = DirectLabel(parent = self, relief = None, text = '', text_scale = PiratesGuiGlobals.TextScaleLarge, text_align = TextNode.ALeft, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 15, pos = (-0.29999999999999999, 0, 0.085000000000000006), textMayChange = 1)
        self.context = None
        xOff = -0.025000000000000001
        self.bOk = FriendInviterButton(text = OTPLocalizer.FriendInviterOK, command = self._FriendInviter__handleOk)
        self.bOk.reparentTo(self)
        self.bOk.setPos(0.0 + xOff, 0, -0.28999999999999998)
        self.bOk.hide()
        ...
        self.bCancel.setPos(0.0 + xOff, 0, -0.28999999999999998)
        self.bCancel.hide()
        ...
        self.bYes.setPos(-0.10000000000000001 + xOff, 0, -0.32000000000000001)
        self.bYes.hide()
        self.bNo = FriendInviterButton(text = OTPLocalizer.FriendInviterNo, command = self._FriendInviter__handleNo)
        self.bNo.reparentTo(self)
        self.bNo.setPos(0.10000000000000001 + xOff, 0, -0.32000000000000001)
        self.bNo.hide()
