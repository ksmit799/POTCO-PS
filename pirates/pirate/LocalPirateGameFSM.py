...
class LocalPirateGameFSM(PlayerPirateGameFSM):
    ...
    def defaultFilter(self, request, args):
        ...
        if self.state == 'Death':
            if request not in ('Off', 'ThrownInJail', 'Unconcious', 'TeleportIn', 'TeleportOut', 'LandRoam', 'PVPWait', 'PVPComplete'):
                return None
    ...
    def exitWaterRoam(self):
        ...
        self.av.controlManager.get('walk').setGravity(32.173999999999999 * 2.0)
    ...
    def enterTeleportIn(self, extraArgs = []):
        ...
        self.av.guiMgr.request('Cutscene')
        self.av.motionFSM.request('MoveLock')
        self.acceptOnce(base.transitions.FadeInEvent, self.av.b_setGameState, [
            'LandRoam'])
    ...
    enterShipBoarding = report(types = [
        'args'], dConfigParam = 'dteleport')(enterShipBoarding)
    ...
    exitShipBoarding = report(types = [
        'args'], dConfigParam = 'dteleport')(exitShipBoarding)
    ...
    enterEnterTunnel = report(types = [
        'args',
        'frameCount'], dConfigParam = 'dteleport')(enterEnterTunnel)
    ...
    enterLeaveTunnel = report(types = [
        'args',
        'frameCount'], dConfigParam = 'dteleport')(enterLeaveTunnel)
