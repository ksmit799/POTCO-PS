...
class Bayonet(Weapon.Weapon):
    ...
    def getReturnIval(self, av, blendInT = 0, blendOutT = 0.10000000000000001):
        track = Parallel(av.actorInterval('gun_putaway', playRate = 2, endFrame = 37, blendInT = blendInT, blendOutT = blendOutT), Sequence(Wait(0.59999999999999998), Func(self.detachFrom, av)))
