...
class CombatAnimations:
    ...
    BASE_GRENADE_POWER = 0.80000000000000004
    ...
    def getSlash(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.29999999999999999), Func(av.currentWeapon.beginAttack, av, wantTrail), Func(av.currentWeapon.playSkillSfx, skillId, av, 0, wantTrail), av.actorInterval('cutlass_combo', playRate = 1.0, startFrame = 31, endFrame = 62, blendInT = 0.5, blendOutT = 0.29999999999999999), Func(av.currentWeapon.endAttack, av)), Sequence(Wait(delay), Func(self.unlockInput, av)))
        return ival
    ...
    def getCleave(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.40000000000000002), Func(av.currentWeapon.beginAttack, av, wantTrail), Func(av.currentWeapon.playSkillSfx, skillId, av, 0, wantTrail), av.actorInterval('cutlass_combo', playRate = 1.0, startFrame = 63, endFrame = 101, blendInT = 0.5, blendOutT = 0.29999999999999999), Func(av.currentWeapon.endAttack, av)), Sequence(Wait(delay), Func(self.unlockInput, av)))
        return ival
    ...
    def getFlourish(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        delay = 1.5800000000000001
        if av == localAvatar and av.guiMgr.combatTray.onLastAttack:
            delay = 2.0800000000000001
        
        wantTrail = 1
        if skillResult in MISTIMEDLIST:
            wantTrail = 0
        
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.40000000000000002), Func(av.currentWeapon.beginAttack, av, wantTrail), Func(av.currentWeapon.playSkillSfx, skillId, av, 0, wantTrail), av.actorInterval('cutlass_combo', playRate = 1.0, startFrame = 102, endFrame = 150, blendInT = 0.5, blendOutT = 0.29999999999999999), Func(av.currentWeapon.endAttack, av)), Sequence(Wait(delay), Func(self.unlockInput, av)))
        return ival
    ...
    def getBlowbackSweep(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX2():
            ...
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsMedium:
                ...
                if effect:
                    ...
                    effect.setEffectColor(Vec4(0.14999999999999999, 0.14999999999999999, 0.14999999999999999, 1.0))
                    effect.play()
        ...
        ival = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.motionFSM.off), Func(av.currentWeapon.hideMouse, av), Func(av.currentWeapon.setTrailLength, 0.69999999999999996), Func(av.currentWeapon.beginAttack, av), av.actorInterval('cutlass_sweep', playRate = 1.0, startFrame = 1, endFrame = 10, blendOutT = 0), Func(startVFX), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval('cutlass_sweep', playRate = 1.0, startFrame = 11, endFrame = 15, blendInT = 0, blendOutT = 0), Func(startVFX2), av.actorInterval('cutlass_sweep', playRate = 1.0, startFrame = 16, endFrame = 35, blendInT = 0), Func(av.currentWeapon.endAttack, av), Func(av.considerEnableMovement), Func(self.unlockInput, av))
        return ival
    ...
    def getFireSweep(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX2():
            ...
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsMedium:
                ...
                if effect:
                    effect.reparentTo(av)
                    effect.setPos(0, 0, 0.25)
                    effect.setEffectColor(Vec4(1, 0.80000000000000004, 0.40000000000000002, 0.40000000000000002))
                    effect.play()
        ...
        ival = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.motionFSM.off), Func(av.currentWeapon.startSpecialEffect, skillId), Func(av.currentWeapon.hideMouse, av), Func(av.currentWeapon.setTrailLength, 0.69999999999999996), Func(av.currentWeapon.beginAttack, av), av.actorInterval('cutlass_sweep', playRate = 1.0, startFrame = 1, endFrame = 10, blendOutT = 0), Func(startVFX), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval('cutlass_sweep', playRate = 1.0, startFrame = 11, endFrame = 15, blendInT = 0, blendOutT = 0), Func(startVFX2), av.actorInterval('cutlass_sweep', playRate = 1.0, startFrame = 16, endFrame = 35, blendInT = 0), Func(av.currentWeapon.endAttack, av), Func(av.considerEnableMovement), Func(self.unlockInput, av))
        return ival
        ...
        def startVFX2():
            ...
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsMedium:
                ...
                if effect:
                    effect.reparentTo(av)
                    effect.setPos(0, 0, 0.25)
                    effect.setEffectColor(Vec4(0.40000000000000002, 0.59999999999999998, 1, 0.59999999999999998))
                    effect.play()
        ...
        def startVFX2():
            ...
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsMedium:
                ...
                if effect:
                    effect.reparentTo(av)
                    effect.setPos(0, 0, 0.25)
                    effect.setEffectColor(Vec4(0.69999999999999996, 0.90000000000000002, 0.5, 0.5))
                    effect.play()
    ...
    def getBrawl(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        ival = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.motionFSM.off), Func(av.currentWeapon.hideMouse, av), Func(av.currentWeapon.setTrailLength, 0.29999999999999999), Func(av.currentWeapon.beginAttack, av), Func(av.currentWeapon.playSkillSfx, skillId, av))
    ...
    def getMonkeyPanic(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX():
            ...
            flashEffect.setEffectColor(Vec4(1, 0.20000000000000001, 0.20000000000000001, 1))
            flashEffect.play()
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
        ...
        ival = Sequence(Func(self.lockInput, av), Func(av.motionFSM.off), Func(av.currentWeapon.hideMouse, av), Func(av.currentWeapon.setTrailLength, 0.14999999999999999), Func(av.currentWeapon.beginAttack, av), Func(av.currentWeapon.playSkillSfx, skillId, av), Func(startVFX), av.actorInterval('emote_thriller', playRate = 1.0, startFrame = 265, endFrame = 320, blendInT = 0.5, blendOutT = 0.5), Func(av.currentWeapon.endAttack, av), Func(av.considerEnableMovement), Func(self.unlockInput, av))
        return ival
    ...
    def getBroadswordSlash(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.29999999999999999), Func(av.currentWeapon.beginAttack, av, wantTrail), Func(av.currentWeapon.playSkillSfx, skillId, av, 0, wantTrail), av.actorInterval('broadsword_combo', playRate = 1.0, startFrame = 29, endFrame = 60, blendInT = 0.5, blendOutT = 0.29999999999999999), Func(av.currentWeapon.endAttack, av)), Sequence(Wait(0.94999999999999996), Func(self.unlockInput, av)))
        return ival
    ...
    def getBroadswordCleave(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.40000000000000002), Func(av.currentWeapon.beginAttack, av, wantTrail), Func(av.currentWeapon.playSkillSfx, skillId, av, 0, wantTrail), av.actorInterval('broadsword_combo_motion', playRate = 1.0, startFrame = 61, endFrame = 76, blendInT = 0.10000000000000001, blendOutT = 0), av.actorInterval('broadsword_combo', playRate = 1.0, startFrame = 77, endFrame = 96, blendInT = 0, blendOutT = 0.29999999999999999), Func(av.currentWeapon.endAttack, av)), Sequence(Wait(1.05), Func(self.unlockInput, av)))
        return ival
    ...
    def getBroadswordFlourish(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.40000000000000002), Func(av.currentWeapon.beginAttack, av, wantTrail), Func(av.currentWeapon.playSkillSfx, skillId, av, 0, wantTrail), av.actorInterval('broadsword_combo_motion', playRate = 1.0, startFrame = 97, endFrame = 112, blendInT = 0.10000000000000001, blendOutT = 0), av.actorInterval('broadsword_combo', playRate = 1.0, startFrame = 113, endFrame = 128, blendInT = 0, blendOutT = 0), Func(av.currentWeapon.endAttack, av)), Sequence(Wait(0.94999999999999996), Func(self.unlockInput, av)))
        return ival
    ...
    def getSabreSlash(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.29999999999999999), Func(av.currentWeapon.beginAttack, av, wantTrail), Func(av.currentWeapon.playSkillSfx, skillId, av, 0, wantTrail), av.actorInterval('sabre_combo', playRate = 1.0, startFrame = 20, endFrame = 37, blendInT = 0.10000000000000001, blendOutT = 0.10000000000000001), Func(av.currentWeapon.endAttack, av)), Sequence(Wait(0.40000000000000002), Func(self.unlockInput, av)))
        return ival
    ...
    def getSabreCleave(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.40000000000000002), Func(av.currentWeapon.beginAttack, av, wantTrail), Func(av.currentWeapon.playSkillSfx, skillId, av, 0, wantTrail), av.actorInterval('sabre_combo', playRate = 1.0, startFrame = 38, endFrame = 81, blendInT = 0.5, blendOutT = 0.29999999999999999), Func(av.currentWeapon.endAttack, av)), Sequence(Wait(1.0), Func(self.unlockInput, av)))
        return ival
    ...
    def getSabreFlourish(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.40000000000000002), Func(av.currentWeapon.beginAttack, av, wantTrail), Func(av.currentWeapon.playSkillSfx, skillId, av, 0, wantTrail), av.actorInterval('sabre_combo_motion', playRate = 1.0, startFrame = 82, endFrame = 94, blendInT = 0.10000000000000001, blendOutT = 0), av.actorInterval('sabre_combo', playRate = 1.0, startFrame = 95, endFrame = 121, blendInT = 0, blendOutT = 0.10000000000000001), Func(av.currentWeapon.endAttack, av)), Sequence(Wait(1.0), Func(self.unlockInput, av)))
        return ival
    ...
    def getSwipe(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.29999999999999999), Func(av.currentWeapon.beginAttack, av, wantTrail), Func(av.currentWeapon.playSkillSfx, skillId, av, 0, wantTrail), av.actorInterval('dagger_combo', playRate = 1.0, startFrame = 29, endFrame = 53, blendInT = 0.5, blendOutT = 0.5), Func(av.currentWeapon.hideSpinBlur), Func(av.currentWeapon.endAttack, av)), Sequence(Wait(delay), Func(self.unlockInput, av)), Sequence(Wait(0.10000000000000001), Func(av.currentWeapon.showSpinBlur)))
        return ival
    ...
    def getEviscerate(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        ival = Parallel(Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.59999999999999998), Func(av.currentWeapon.beginAttack, av, wantTrail), Func(av.currentWeapon.playSkillSfx, skillId, av, 0, wantTrail), av.actorInterval('dagger_combo', playRate = 1.0, startFrame = 88, endFrame = 142, blendInT = 0.5, blendOutT = 0.5), Func(av.currentWeapon.endAttack, av)), Sequence(Wait(delay), Func(self.unlockInput, av)))
        return ival
    ...
    def getDaggerAspInterval(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        (targetPos, speed, impactT) = av.getProjectileInfo(skillId, target)
        track = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.25), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval('knife_throw', endFrame = 17, blendInT = 0.20000000000000001, blendOutT = 0), Parallel(av.actorInterval('knife_throw', startFrame = 18, blendInT = 0, blendOutT = 0.40000000000000002), Func(self.throwDagger, av, speed, targetPos, skillId = skillId, target = target), Func(av.currentWeapon.hideWeapon)), Func(av.currentWeapon.showWeapon), Func(self.unlockInput, av))
        return track
    ...
    def getDaggerAdderInterval(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        motion_color = [
            Vec4(0.10000000000000001, 1.0, 0.40000000000000002, 1.0),
            Vec4(0.5, 1.0, 0.40000000000000002, 1.0)]
        (targetPos, speed, impactT) = av.getProjectileInfo(skillId, target)
        track = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.25), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval('knife_throw', endFrame = 17, blendInT = 0.20000000000000001, blendOutT = 0), Parallel(av.actorInterval('knife_throw', startFrame = 18, blendInT = 0, blendOutT = 0.40000000000000002), Func(self.throwDagger, av, 1.0, targetPos, motion_color, skillId = skillId, target = target), Func(av.currentWeapon.hideWeapon)), Func(av.currentWeapon.showWeapon), Func(self.unlockInput, av))
        return track
    ...
    def getDaggerSidewinderInterval(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        motion_color = [
            ...
            Vec4(1.0, 0.20000000000000001, 0.0, 1.0)]
        (targetPos, speed, impactT) = av.getProjectileInfo(skillId, target)
        track = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.25), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval('dagger_asp', endFrame = 7, blendInT = 0.10000000000000001, blendOutT = 0), Parallel(av.actorInterval('dagger_asp', startFrame = 8, blendInT = 0, blendOutT = 0.40000000000000002), Func(self.throwDagger, av, 1.0, targetPos, motion_color, roll = 90, skillId = skillId, target = target), Func(av.currentWeapon.hideWeapon)), Func(av.currentWeapon.showWeapon), Func(self.unlockInput, av))
        return track
    ...
    def getDaggerViperNestInterval(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        numDaggers = 12.0
        time = 0.69999999999999996
        placeHolder = av.attachNewNode('daggerPlaceHolder')
        daggerTossIval = Parallel(Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.25), av.actorInterval('dagger_vipers_nest', startFrame = 21, endFrame = 35, blendInT = 0, blendOutT = 0.40000000000000002), Func(av.currentWeapon.showWeapon), Func(av.considerEnableMovement), Func(self.unlockInput, av)))
    ...
    def getDaggerThrowCombo1Interval(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        motion_color = [
            ...
            Vec4(1.0, 0.20000000000000001, 0.0, 1.0)]
        (targetPos, speed, impactT) = av.getProjectileInfo(skillId, target)
        track = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.25), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval('dagger_throw_combo', endFrame = 6, playRate = 1.5, blendInT = 0.10000000000000001, blendOutT = 0), Parallel(av.actorInterval('dagger_throw_combo', startFrame = 7, endFrame = 23, playRate = 1.5, blendInT = 0, blendOutT = 0.40000000000000002), Func(self.throwDagger, av, 0.5, targetPos, motion_color, skillId = skillId, target = target), Func(av.currentWeapon.hideWeapon)), Func(av.currentWeapon.showWeapon), Func(self.unlockInput, av))
        return track
    ...
    def getDaggerThrowCombo2Interval(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        motion_color = [
            ...
            Vec4(1.0, 0.20000000000000001, 0.0, 1.0)]
        (targetPos, speed, impactT) = av.getProjectileInfo(skillId, target)
        track = Sequence(Func(av.currentWeapon.reparentTo, av.leftHandNode), Func(av.attackTire), Func(self.lockInput, av), Func(av.currentWeapon.setTrailLength, 0.25), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval('dagger_throw_combo', startFrame = 24, endFrame = 30, playRate = 1.5, blendInT = 0.10000000000000001, blendOutT = 0), Parallel(av.actorInterval('dagger_throw_combo', startFrame = 31, endFrame = 46, playRate = 1.5, blendInT = 0, blendOutT = 0.40000000000000002), Func(self.throwDagger, av, 0.5, targetPos, motion_color, leftHand = True, skillId = skillId, target = target), Func(av.currentWeapon.hideWeapon)), Func(av.currentWeapon.reparentTo, av.rightHandNode), Func(av.currentWeapon.showWeapon), Func(self.unlockInput, av))
        return track
    ...
    def getDaggerThrowCombo3Interval(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        (targetPos, speed, impactT) = av.getProjectileInfo(skillId, target)
        track = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(dagger2.reparentTo, av.leftHandNode), Func(av.currentWeapon.setTrailLength, 0.25), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval('dagger_throw_combo', startFrame = 47, endFrame = 56, playRate = 1.5, blendInT = 0.10000000000000001, blendOutT = 0), Parallel(av.actorInterval('dagger_throw_combo', startFrame = 57, endFrame = 78, playRate = 1.5, blendInT = 0, blendOutT = 0.10000000000000001), Func(self.throwDagger, av, 0.5, targetPos, motion_color, skillId = skillId, target = target), Sequence(Wait(0.010999999999999999), Func(self.throwDagger, av, 0.5, targetPos, motion_color, leftHand = True, skillId = skillId, target = target)), Func(av.setSecondWeapon, None), Func(av.currentWeapon.hideWeapon)), Func(av.currentWeapon.showWeapon), Func(self.unlockInput, av))
        return track
    ...
    def getDaggerThrowCombo4Interval(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        av.setSecondWeapon(dagger2)
        (targetPos, speed, impactT) = av.getProjectileInfo(skillId, target)
        track = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(dagger2.reparentTo, av.leftHandNode), Func(av.currentWeapon.setTrailLength, 0.25), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval('dagger_throw_combo', startFrame = 79, endFrame = 93, playRate = 1.5, blendInT = 0.10000000000000001, blendOutT = 0), Parallel(av.actorInterval('dagger_throw_combo', startFrame = 94, endFrame = 130, playRate = 1.5, blendInT = 0, blendOutT = 0.40000000000000002), Func(self.throwDagger, av, 0.5, targetPos, motion_color, roll = 90, skillId = skillId, target = target), Sequence(Wait(0.010999999999999999), Func(self.throwDagger, av, 0.5, targetPos, motion_color, roll = 90, leftHand = True, skillId = skillId, target = target)), Func(av.setSecondWeapon, None), Func(av.currentWeapon.hideWeapon)), Func(av.currentWeapon.showWeapon), Func(self.unlockInput, av))
        return track
    ...
    def getDaggerRainInterval(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        (targetPos, speed, impactT) = av.getProjectileInfo(skillId, target)
        numDaggers = 3.0
        daggerTossIval = Parallel(Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.25), av.actorInterval('dagger_asp', startFrame = 7, endFrame = 20, blendInT = 0, blendOutT = 0.40000000000000002), Func(av.currentWeapon.showWeapon), Func(av.considerEnableMovement), Func(self.unlockInput, av)))
        for i in range(numDaggers):
            daggerTossIval.append(Wait(0.010999999999999999 * i))
            daggerTossIval.append(Func(self.throwDaggerRain, av, random.uniform(0.94999999999999996, 1.05), targetPos, motion_color, roll = 90, skillId = skillId, target = target))
    ...
    def getDaggerAcidDaggerInterval(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        motion_color = [
            ...
            Vec4(1.0, 1.0, 0.20000000000000001, 1.0)]
        (targetPos, speed, impactT) = av.getProjectileInfo(skillId, target)
        track = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.setTrailLength, 0.25), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval('dagger_asp', endFrame = 7, blendInT = 0.10000000000000001, blendOutT = 0), Parallel(av.actorInterval('dagger_asp', startFrame = 8, blendInT = 0, blendOutT = 0.40000000000000002), Func(self.throwDagger, av, 1.0, targetPos, motion_color, roll = 90, skillId = skillId, target = target), Func(av.currentWeapon.hideWeapon)), Func(av.currentWeapon.showWeapon), Func(self.unlockInput, av))
        return track
    ...
    def getPistolChargingAnim(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        if ItemGlobals.shouldStopToAim(subtype):
            track = Sequence(Func(av.motionFSM.moveLock), Func(base.cr.targetMgr.setWantAimAssist, 1), Func(av.setAimMod, -0.5), av.actorInterval(anim, loop = 1, duration = 9999, blendInT = 0.29999999999999999, blendOutT = 0.29999999999999999))
        elif anim:
            track = Sequence(Func(base.cr.targetMgr.setWantAimAssist, 1), Func(av.setAimMod, -0.5), av.actorInterval(anim, loop = 1, duration = 9999, blendInT = 0.29999999999999999, blendOutT = 0.29999999999999999))
        else:
            track = Sequence(Func(base.cr.targetMgr.setWantAimAssist, 1), Func(av.setAimMod, -0.5), av.actorInterval('gun_aim_idle', loop = 1, duration = 9999, blendInT = 0.29999999999999999, blendOutT = 0.29999999999999999))
        return track
    ...
    def getPistolFireAnim(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX():
            ...
            if pistolFlame:
                ...
                pistolFlame.setPos(1.25, 0.29999999999999999, 0)
        ...
        if anim:
            ival = Sequence(Func(base.cr.targetMgr.setWantAimAssist, 0), Func(self.lockInput, av), Func(av.attackTire), Func(av.setAimMod, 0), av.actorInterval(anim, startFrame = 1, endFrame = 3, blendInT = 0.0, blendOutT = 0.0, playRate = 1.0), Func(startVFX), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval(anim, startFrame = 4, endFrame = 12, blendInT = 0.0, blendOutT = 0.0, playRate = 1.0), Func(self.unlockInput, av), av.actorInterval(anim, startFrame = 13, blendInT = 0, blendOutT = 0.29999999999999999, playRate = 1.0))
        else:
            ival = Sequence(Func(base.cr.targetMgr.setWantAimAssist, 0), Func(self.lockInput, av), Func(av.attackTire), Func(av.setAimMod, 0), Func(startVFX), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval('gun_fire', endFrame = 12, blendInT = 0, blendOutT = 0), Func(self.unlockInput, av), av.actorInterval('gun_fire', startFrame = 13, blendInT = 0, blendOutT = 0.29999999999999999))
        del startVFX
        return ival
    ...
    def getPistolTakeAimAnim(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        if anim:
            if subtype in (ItemGlobals.BAYONET, ItemGlobals.MUSKET, ItemGlobals.BLUNDERBUSS):
                ...
                ival = Sequence(Func(base.cr.targetMgr.setWantAimAssist, 0), Func(av.setAimMod, 0), Func(self.lockInput, av), Func(av.attackTire), Func(startVFX), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval(anim, playRate = 1, startFrame = 1, blendInT = 0, blendOutT = 0.29999999999999999), Func(self.unlockInput, av))
        else:
            ival = Sequence(Func(base.cr.targetMgr.setWantAimAssist, 0), Func(av.setAimMod, 0), Func(self.lockInput, av), Func(av.attackTire), Func(startVFX), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval('gun_fire', playRate = 1, blendInT = 0, blendOutT = 0.29999999999999999), Func(self.unlockInput, av))
        del startVFX
        return ival
    ...
    def getPistolScattershotAnim(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX():
            ...
            if pistolFlame:
                ...
                pistolFlame.setHpr(0, 0, 90)
                pistolFlame.setScale(0.40000000000000002)
                pistolFlame.play()
            ...
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsMedium:
                ...
                if effect:
                    ...
                    effect.setScale(0.20000000000000001)
                    effect.time = 0.5
                    effect.play()
    ...
    def getGrenadeReloadAnim(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        if av.currentWeapon.ammoSkillId == InventoryType.GrenadeSiege:
            track = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.detachFrom, av), av.actorInterval('bigbomb_draw', endFrame = 11, blendInT = 0, blendOutT = 0), Func(av.currentWeapon.attachTo, av), av.actorInterval('bigbomb_draw', startFrame = 12, blendInT = 0, blendOutT = 0.29999999999999999), Func(finishReload), Func(self.unlockInput, av))
        else:
            track = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.currentWeapon.detachFrom, av), av.actorInterval('bomb_draw', endFrame = 5, blendInT = 0, blendOutT = 0), Func(av.currentWeapon.attachTo, av), av.actorInterval('bomb_draw', startFrame = 5, blendInT = 0, blendOutT = 0.29999999999999999), Func(finishReload), Func(self.unlockInput, av))
        del finishReload
        return track
    ...
    def getGrenadeChargingAnim(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        if av.currentWeapon.ammoSkillId == InventoryType.GrenadeSiege:
            track = Parallel(Sequence(Func(av.motionFSM.moveLock), Func(av.currentWeapon.hideMouse, av), av.actorInterval('bigbomb_charge', blendInT = 0.29999999999999999, blendOutT = 0), av.actorInterval('bigbomb_charge_loop', loop = 1, duration = 9999, blendInT = 0, blendOutT = 0.29999999999999999)), SoundInterval(av.currentWeapon.chargingSfx, loop = 1, node = av, cutOff = 60))
        else:
            track = Parallel(Sequence(Func(av.setAimMod, -0.5), Func(av.currentWeapon.hideMouse, av), av.actorInterval('bomb_charge', blendInT = 0.29999999999999999, blendOutT = 0), av.actorInterval('bomb_charge_loop', loop = 1, duration = 9999, blendInT = 0, blendOutT = 0.29999999999999999)), SoundInterval(av.currentWeapon.chargingSfx, loop = 1, node = av, cutOff = 60))
        return track
    ...
    def getGrenadeThrow(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        if ammoSkillId == InventoryType.GrenadeSiege:
            ...
            track = Parallel(Func(self.lockInput, av), Func(av.attackTire), Func(av.setAimMod, 0), Func(av.motionFSM.off), Func(av.currentWeapon.hideMouse, av), Func(av.currentWeapon.playSkillSfx, av.currentWeapon.ammoSkillId, av), Sequence(av.actorInterval('bigbomb_throw', blendInT = 0.29999999999999999, blendOutT = 0.29999999999999999), Func(av.considerEnableMovement), Func(self.unlockInput, av)), Sequence(Wait(attachTime), Func(av.currentWeapon.detachFrom, av), Func(self.spawnGrenade, av, skillId, ammoSkillId, charge, target, skillResult)))
        else:
            attachTime = av.getFrameTime('bomb_throw', 15)
            track = Parallel(Func(self.lockInput, av), Func(av.attackTire), Func(av.setAimMod, 0), Func(av.currentWeapon.playSkillSfx, skillId, av), Sequence(av.actorInterval('bomb_throw', blendInT = 0.29999999999999999, blendOutT = 0.29999999999999999), Func(self.unlockInput, av)), Sequence(Wait(attachTime), Func(av.currentWeapon.detachFrom, av), Func(self.spawnGrenade, av, skillId, ammoSkillId, charge, target, skillResult)))
        return track
    ...
    def getGrenadeLongVolley(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        if ammoSkillId == InventoryType.GrenadeSiege:
            ...
            track = Parallel(Func(self.lockInput, av), Func(av.attackTire), Func(av.setAimMod, 0), Func(av.motionFSM.off), Func(av.currentWeapon.hideMouse, av), Func(av.currentWeapon.playSkillSfx, av.currentWeapon.ammoSkillId, av), Sequence(av.actorInterval('bigbomb_charge_throw', blendInT = 0.29999999999999999, blendOutT = 0.29999999999999999), Func(av.considerEnableMovement), Func(self.unlockInput, av)), Sequence(Wait(attachTime), Func(av.currentWeapon.detachFrom, av), Func(self.spawnGrenade, av, skillId, ammoSkillId, charge, target, skillResult)))
        else:
    ...
    def getPoke(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ival = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(av.attackTire), Func(self.playCastingAnim, av), av.actorInterval('voodoo_doll_poke', endFrame = 50, playRate = 1.0, blendInT = 0.29999999999999999, blendOutT = 0.29999999999999999), Func(self.unlockInput, av))
        return ival
    ...
    def getEvilEye(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX():
            ...
            if attuneEffect:
                ...
                attuneEffect.setEffectColor(Vec4(0.20000000000000001, 0.10000000000000001, 0.5, 1))
                ...
                if target:
                    ...
                    dummy.removeNode()
                moveIval = LerpPosInterval(attuneEffect, 0.40000000000000002, targetPos)
                moveIval.start()
            

        ival = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(startVFX), av.actorInterval('emote_anger', playRate = 2.0, blendInT = 0.20000000000000001, blendOutT = 0.29999999999999999), Func(self.unlockInput, av))
        return ival
        ...
        def startVFX():
            ...
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsMedium:
                ...
                if auraPulse:
                    ...
                    auraPulse.setEffectColor(Vec4(1, 0.90000000000000002, 0.59999999999999998, 0.75))
            ...
            flashEffect.fadeTime = 1.0
            flashEffect.setEffectColor(Vec4(1, 0.90000000000000002, 0.59999999999999998, 1))
            flashEffect.play()
            auraEffect = VoodooAura2.getEffect(unlimited)
            if auraEffect:
                auraEffect.reparentTo(render)
                auraEffect.setPos(av, 0, 2, 4)
                auraEffect.setEffectColor(Vec4(1, 0.90000000000000002, 0.59999999999999998, 0.14999999999999999))
                ...
                if target:
                    if hasattr(target, 'creature') and target.creature:
                        ...
                        targetPos = target.headNode.getPos(render)
                    moveIval = LerpPosInterval(auraEffect, 0.40000000000000002, targetPos)
                    moveIval.start()
                
            

        ival = Sequence(Func(self.lockInput, av), av.actorInterval('voodoo_tune', playRate = 1.5, startFrame = 0, endFrame = 20, blendInT = 0.10000000000000001, blendOutT = 0.0), Func(startVFX), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval('voodoo_tune', playRate = 1.5, startFrame = 20, endFrame = 35, blendInT = 0.0, blendOutT = 0.29999999999999999), Func(self.unlockInput, av))
        return ival

    
    def getAttune(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ival = Sequence(Func(self.lockInput, av), Func(av.attackTire), av.actorInterval('voodoo_tune', playRate = 2.0, endFrame = 35, blendInT = 0.20000000000000001, blendOutT = 0.29999999999999999), Func(self.unlockInput, av))
        return ival
    ...
    def getUnattune(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        ival = Sequence(Func(self.lockInput, av), Func(av.currentWeapon.playUnattuneSfx, av.currentWeapon), av.actorInterval('voodoo_swarm', playRate = 1.0, blendInT = 0.29999999999999999, blendOutT = 0.29999999999999999), Func(self.unlockInput, av))
        return ival

    
    def getHeal(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ival = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(self.playCastingAnim, av), av.actorInterval('voodoo_swarm', playRate = 1.0, blendInT = 0.29999999999999999, blendOutT = 0.29999999999999999), Func(self.unlockInput, av))
        return ival
    ...
    def getHexWard(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX():
            ...
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsMedium:
                ...
                if auraPulse:
                    auraPulse.reparentTo(av)
                    auraPulse.setEffectColor(Vec4(0.40000000000000002, 0.29999999999999999, 1, 0.75))
                    auraPulse.effectModel.setPos(0, 3, 4.0)
                    auraPulse.setScale(1.0)
                    if target:
                        auraPulse.lookAt(target)
            ...
            flashEffect.setScale(10.0)
            flashEffect.fadeTime = 1.0
            flashEffect.setEffectColor(Vec4(0.20000000000000001, 0.59999999999999998, 1, 1))
            flashEffect.play()

        ival = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(self.playCastingAnim, av), Func(startVFX), av.actorInterval('voodoo_swarm', playRate = 1.0, blendInT = 0.29999999999999999, blendOutT = 0.29999999999999999), Func(self.unlockInput, av))
        return ival
    ...
    def getCaptainsResolve(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX():
            ...
            if pulseFlash:
                ...
                pulseFlash.setEffectColor(Vec4(0.29999999999999999, 1, 1, 0.80000000000000004))
            ...
            if coneRays:
                ...
                coneRays.setEffectColor(Vec4(0.29999999999999999, 1, 1, 0.20000000000000001))
                coneRays.play()
        ...
        def startVFX2():
            ...
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsMedium:
                ...
                if healDisc:
                    healDisc.setEffectColor(Vec4(0.29999999999999999, 1, 1, 0.34999999999999998))
    ...
    def getLifeDrain(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX():
            ...
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                ...
                if effect:
                    ...
                    effect.setScale(1, 1, av.getHeight() / 2.0)
                    effect.setEffectColor(Vec4(0.20000000000000001, 0.20000000000000001, 1.0, 1))
        ...
        ival = Sequence(Func(self.lockInput, av), Func(av.attackTire), Func(self.playCastingAnim, av), Parallel(av.actorInterval('voodoo_swarm', playRate = 1.0, blendInT = 0.29999999999999999, blendOutT = 0.29999999999999999), Sequence(Wait(0.5), Func(startVFX))), Func(self.unlockInput, av))
        del startVFX
        return ival
        ...
        def startVFX():
            ...
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsMedium:
                ...
                if av.currentWeapon.effect and not av.currentWeapon.isEmpty():
                    ...
                    av.currentWeapon.effect.setPos(av.currentWeapon, -0.10000000000000001, 1.5, 0)
        ...
        def startVFX():
            ...
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsMedium:
                ...
                if av.currentWeapon.effect and not av.currentWeapon.isEmpty():
                    ...
                    av.currentWeapon.effect.setEffectColor(av.currentWeapon.getEffectColor(av.currentWeapon.itemId))
                    av.currentWeapon.effect.setScale(0.90000000000000002, 0.90000000000000002, 0.90000000000000002)
                    av.currentWeapon.effect.startLoop()
    ...
    def getChargeHellfireAnim(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX():
            unlimited = av.isLocal()
            offset = av.currentWeapon.getOffset(av.currentWeapon.itemId) + Vec3(0, 0.20000000000000001, 0)
            av.currentWeapon.effect = FlamingSkull.getEffect(unlimited)
            if av.currentWeapon.effect and not av.currentWeapon.isEmpty():
                av.currentWeapon.effect.reparentTo(av.currentWeapon)
                av.currentWeapon.effect.setPos(av.currentWeapon, offset + Vec3(0.20000000000000001, 1, 0.29999999999999999))
    ...
    def getBoxingPunch(self, av, skillId, ammoSkillId, charge, target, skillResult):
        return Sequence(Func(self.lockInput, av), av.actorInterval('boxing_punch', playRate = 1.0, blendInT = 0.10000000000000001, blendOutT = 0.20000000000000001), Func(self.unlockInput, av))
    ...
    def getBayonetFireAnim(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX():
            ...
            if pistolFlame:
                pistolFlame.reparentTo(av.currentWeapon)
                pistolFlame.setPos(2.7999999999999998, 0.10000000000000001, 0)
                pistolFlame.setHpr(0, 0, 90)
                pistolFlame.setScale(1)
                pistolFlame.play()
        ...
        anim = ItemGlobals.getFireAnim(ItemGlobals.getSubtype(av.currentWeaponId))
        ival = Sequence(Func(base.cr.targetMgr.setWantAimAssist, 0), Func(self.lockInput, av), Func(startVFX), Func(av.currentWeapon.playSkillSfx, skillId, av), av.actorInterval(anim, startFrame = 9, endFrame = 14, blendInT = 0.0, blendOutT = 0), Func(self.unlockInput, av), av.actorInterval(anim, startFrame = 15, blendInT = 0, blendOutT = 0.29999999999999999))
        return ival
    ...
    def getStumpStomp(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        ival = Parallel(Sequence(Wait(1.3300000000000001), Func(startVFX)), Sequence(Func(av.currentWeapon.beginAttack, av), av.actorInterval('jump_attack', playRate = 1.0), Func(av.currentWeapon.endAttack, av)))
        return ival
    ...
    def getFlyTrapSpit(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX():
            ...
            if effect:
                effect.reparentTo(render)
                effect.setPos(av, 0, 0, av.height * 0.69999999999999996)
                effect.setH(av.getH(render))
                effect.play(targetPos, speed, target)
    ...
    def getTentacleSlap(self, av, skillId, ammoSkillId, charge, target, skillResult):
        anim = Parallel(Func(av.alignWithVictim, 0.40000000000000002), Sequence(ActorInterval(av, 'pound_deck', playRate = 2.0), Func(av.loop, 'idle', playRate = random.uniform(1.0, 1.2))), Sequence(Wait(0.59999999999999998), Func(self.playShockwave, av)))
        return anim

    
    def getTentaclePound(self, av, skillId, ammoSkillId, charge, target, skillResult):
        anim = Parallel(Func(av.alignWithVictim, 0.40000000000000002), Sequence(ActorInterval(av, 'pound_deck', playRate = 2.0), Func(av.loop, 'idle', blendT = 0, playRate = random.uniform(1.0, 1.2))))
        return anim

    
    def getTentacleEnsnare(self, av, skillId, ammoSkillId, charge, target, skillResult):
        anim = Sequence(Parallel(ActorInterval(av, 'grab', playRate = 1.0), Func(av.alignWithVictim, 0.66000000000000003), Sequence(Wait(0.66000000000000003), Func(av.setupEnsnare), Wait(1.29), Func(av.pickupTarget))), Func(av.loop, 'grab_idle', playRate = random.uniform(1.0, 1.2)))
        return anim

    
    def getTentaclePiledriver(self, av, skillId, ammoSkillId, charge, target, skillResult):
        anim = Sequence(Parallel(ActorInterval(av, 'grab_slam', playRate = 1.0), Sequence(Wait(2.9300000000000002), Func(av.piledriveTarget))), Func(av.loop, 'idle', playRate = random.uniform(1.0, 1.2)))
        return anim
    ...
    def getGraveBlindAnim(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX():
            ...
            if effect:
                effect.reparentTo(av.getParent())
                effect.setEffectColor(Vec4(0.40000000000000002, 0.59999999999999998, 0.10000000000000001, 1))
                effect.radius = av.cr.battleMgr.getModifiedAttackAreaRadius(av, skillId, ammoSkillId)
                effect.setPos(av, 0.0, 0.0, 0.0)
                effect.play()
    ...
    def getCorruptionAnim(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX():
            ...
            if effect:
                ...
                effect.setPos(av, 0, 5, 0)
                effect.radius = av.cr.battleMgr.getModifiedAttackAreaRadius(av, skillId, ammoSkillId)
                effect.setEffectColor(Vec4(0.80000000000000004, 1.0, 0.20000000000000001, 1.0))
                effect.play()
            ...
            if effect:
                ...
                effect.setPos(av, 0, 5, 0)
                effect.effectScale = av.cr.battleMgr.getModifiedAttackAreaRadius(av, skillId, ammoSkillId)
                effect.changeEffectColor(Vec4(0.80000000000000004, 1.0, 0.10000000000000001, 1.0))
                effect.duration = 2.5
                effect.play()
    ...
    def getSoulHarvestAnim(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ...
        def startVFX():
            ...
            if effect:
                effect.reparentTo(av.getParent())
                effect.setEffectColor(Vec4(0.80000000000000004, 1, 0.20000000000000001, 0.69999999999999996))
                effect.setPos(av, 0.0, 0.0, 0.0)
                effect.setScale(1.0, 1.0, 1.0)
                effect.setHpr(0.0, 0.0, 0.0)
                effect.play()
            ...
            if effect:
                effect.reparentTo(av.getParent())
                effect.setEffectColor(Vec4(0.80000000000000004, 1, 0.20000000000000001, 1))
                effect.setPos(av, 0.0, 0.0, 0.0)
                effect.play()
    ...
    def getSummonHelp(self, av, skillId, ammoSkillId, charge, target, skillResult):
        ival = Sequence(Func(self.lockInput, av), Func(av.motionFSM.off), Func(self.playCastingAnim, av), av.actorInterval('voodoo_swarm', playRate = 1.0, blendInT = 0.29999999999999999, blendOutT = 0.29999999999999999), Func(av.considerEnableMovement), Func(self.unlockInput, av))
        return ival
