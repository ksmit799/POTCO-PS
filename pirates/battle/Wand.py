...
class Wand(Weapon.Weapon):
    ...
    effectTypeInfo = {
        ItemGlobals.GemGlowPurple: Vec4(0.5, 0.20000000000000001, 1, 1),
        ...
        ItemGlobals.GemGlowOrange: Vec4(1, 0.59999999999999998, 0, 1) }
    ...
    def startChargeEffect(self):
        ...
        if self.gem and not self.gem.isEmpty():
            ...
            if self.glowEffect:
                ...
                self.glowEffect.effectScale = 0.29999999999999999
