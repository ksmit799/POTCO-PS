...
class DefenseCannonballProjectile(CannonballProjectile):
    ...
    def setIval(self, ival, start = False, offset = 0):
        ...
        if self.ammoSkillId == InventoryType.DefenseCannonTargetedShot:
            if self.target == None:
                taskMgr.doMethodLater(0.050000000000000003, self.findTarget, self.uniqueName('findTarget'))
    ...
    def findTarget(self, task = None):
        ...
        self.collisionRadiusScale *= 1.0049999999999999
    ...
    def updateTarget(self, task = None):
        ...
        self.setIval(s, True)
        taskMgr.doMethodLater(0.20000000000000001, self.updateTarget, self.uniqueName('updateTarget'))
        return Task.done
