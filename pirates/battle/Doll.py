...
class Doll(Weapon.Weapon):
    ...
    effectTypeInfo = {
        ...
        ItemGlobals.DollCloth: (Vec4(0.5, 0.29999999999999999, 1, 1), 'effectCloth'),
        ItemGlobals.DollWitch: (Vec4(1, 0.69999999999999996, 0.69999999999999996, 1), 'effectWitch'),
        ItemGlobals.DollPirate: (Vec4(1, 1, 1, 1), 'effectPirate'),
        ItemGlobals.DollTaboo: (Vec4(1, 1, 1, 1), 'effectTaboo'),
        ItemGlobals.DollMojo: (Vec4(0.69999999999999996, 0.5, 1, 1), 'effectMojo') }
    ...
    def getDrawIval(self, av, ammoSkillId = 0, blendInT = 0.10000000000000001, blendOutT = 0):
        track = Parallel(Func(base.playSfx, self.drawSfx, node = av, cutoff = 60), av.actorInterval('voodoo_draw', playRate = 1.5, endFrame = 35, blendInT = blendInT, blendOutT = blendOutT), Sequence(Wait(0.56000000000000005), Func(self.attachTo, av)))
        return track
