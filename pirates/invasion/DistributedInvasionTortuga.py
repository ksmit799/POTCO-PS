...
class DistributedInvasionTortuga(DistributedInvasionObject.DistributedInvasionObject):
    ...
    def announceGenerate(self):
        ...
        if self.canPlaySfx:
            ...
            self.goodBossMessages = [
                (PLocalizer.InvasionJollyRogerBoss1, None),
                (PLocalizer.InvasionJollyRogerBoss3, None),
                (PLocalizer.InvasionJollyRogerBoss4, None),
                (PLocalizer.InvasionJollyRogerBoss5, None)]
            self.badBossMessages = [
                (PLocalizer.InvasionJollyRogerBoss2, None)]
            self.mainZoneMessages = [
                (PLocalizer.InvasionJollyRogerMainZone1, None),
                (PLocalizer.InvasionJollyRogerMainZone2, None)]
            self.winMessages = [
                (PLocalizer.InvasionJollyRogerEndPlayerWin4, None)]
            self.loseMessages = [
                (PLocalizer.InvasionJollyRogerEndPlayerLose1, None),
                (PLocalizer.InvasionJollyRogerEndPlayerLose2, None),
                (PLocalizer.InvasionJollyRogerEndPlayerLose3, None)]
