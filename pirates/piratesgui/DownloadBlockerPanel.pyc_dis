...
class DownloadBlockerPanel(GuiPanel.GuiPanel):
    ...
    _Messages = {
        Reasons.GENERIC: PLocalizer.DownloadBlockerMsgGeneric,
        Reasons.ISLAND: PLocalizer.DownloadBlockerMsgIsland,
        Reasons.BOAT: PLocalizer.DownloadBlockerMsgBoat,
        Reasons.TELEPORT: PLocalizer.DownloadBlockerMsgTeleport,
        Reasons.LOOKOUT: PLocalizer.DownloadBlockerMsgLookout }
