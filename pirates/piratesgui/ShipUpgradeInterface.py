...
class ShipUpgradeInterface(DirectFrame):
    ...
    def __init__(self, parent, **kw):
        ...
        self.interface.setScale(0.32000000000000001)
        spotsLeft = [
            self.interface.find('**/icon_frames_down/icon_frame_down1'),
            self.interface.find('**/icon_frames_down/icon_frame_down2'),
            self.interface.find('**/icon_frames_down/icon_frame_down3')]
        spotsMiddle = [
            self.interface.find('**/icon_frames_down1/icon_frame_down4'),
            self.interface.find('**/icon_frames_down1/icon_frame_down2'),
            self.interface.find('**/icon_frames_down1/icon_frame_down5')]
        spotsRight = [
            self.interface.find('**/icon_frames_down2/icon_frame_down1'),
            self.interface.find('**/icon_frames_down2/icon_frame_down2'),
            self.interface.find('**/icon_frames_down2/icon_frame_down3')]
        self.spotMarkers = [
            spotsLeft,
            spotsMiddle,
            spotsRight]
        ...
        left = -0.56999999999999995
        top = -0.34000000000000002
        midV = -0.625
        bottom = -0.89500000000000002
        midH = -0.0085000000000000006
        right = 0.56000000000000005
        superRight = 0.56000000000000005
        self.arrowDict = {
            (0, 0): self.interface.find('**/arrows/downgrade_upper_arrow'),
            (0, 1): self.interface.find('**/arrows/downgrade_mid_arrow'),
            (0, 2): self.interface.find('**/arrows/downgrade_lower_arrow'),
            (1, 0): self.interface.find('**/arrows/sidegrade_upper_arrow'),
            (1, 1): None,
            (1, 2): self.interface.find('**/arrows/sidegrade_lower_arrow'),
            (2, 0): self.interface.find('**/arrows/upgrade_upper_arrow'),
            (2, 1): self.interface.find('**/arrows/upgrade_mid_arrow'),
            (2, 2): self.interface.find('**/arrows/Upgrade_lower_arrow') }
    ...
    def setupGui(self):
        ...
        for currencyId in ShipUpgradeGlobals.COST_LIST:
            ...
            tg = TextGraphic(currencyIcon, -0.25, 0.75, -0.31, 0.68999999999999995)
        ...
        for broadsideId in self.broadsideIdList:
            ...
            tg = TextGraphic(broadsideIcon, -0.25, 0.75, -0.31, 0.68999999999999995)
            tpMgr.setGraphic(iconKey, tg)
        ...
        for sailSkillId in self.sailSkillList:
            ...
            tg = TextGraphic(sailSkillIcon, -0.25, 0.75, -0.31, 0.68999999999999995)
            tpMgr.setGraphic(iconKey, tg)
        ...
        self.closeButton = DirectButton(parent = self, relief = None, pos = (1.28, 0, 0.67000000000000004), scale = 0.38, geom = generic_x, image = (generic_box, generic_box, generic_box_over, generic_box), image_scale = 0.69999999999999996, text = '', textMayChange = 1, command = self.close)
        ...
        self.confirmButton = DirectButton(parent = self, relief = None, image = selectImage, image_scale = (0.40000000000000002, 1.0, 0.27000000000000002), image0_color = VBase4(0.65000000000000002, 0.65000000000000002, 0.65000000000000002, 1), image1_color = VBase4(0.40000000000000002, 0.40000000000000002, 0.40000000000000002, 1), image2_color = VBase4(0.90000000000000002, 0.90000000000000002, 0.90000000000000002, 1), image3_color = VBase4(0.40999999999999998, 0.40000000000000002, 0.40000000000000002, 1), text = PLocalizer.UpgradePurchaseConfirm, text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_pos = (0, -0.01), text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (1.01, 0, -0.81999999999999995), state = DGG.DISABLED, command = self.confirmPurchase)
        self.showNextButton = DirectButton(parent = self, relief = None, image = selectImage, image_scale = (0.14999999999999999, 1.0, 0.25), image0_color = VBase4(0.65000000000000002, 0.65000000000000002, 0.65000000000000002, 1), image1_color = VBase4(0.40000000000000002, 0.40000000000000002, 0.40000000000000002, 1), image2_color = VBase4(0.90000000000000002, 0.90000000000000002, 0.90000000000000002, 1), image3_color = VBase4(0.40999999999999998, 0.40000000000000002, 0.40000000000000002, 1), text = PLocalizer.UpgradeShowNext, text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_pos = (0, -0.01), text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (0.5, 0, -0.94999999999999996), state = DGG.NORMAL, command = self.showNext)
        self.showNextButton.hide()
        self.showPrevButton = DirectButton(parent = self, relief = None, image = selectImage, image_scale = (0.14999999999999999, 1.0, 0.25), image0_color = VBase4(0.65000000000000002, 0.65000000000000002, 0.65000000000000002, 1), image1_color = VBase4(0.40000000000000002, 0.40000000000000002, 0.40000000000000002, 1), image2_color = VBase4(0.90000000000000002, 0.90000000000000002, 0.90000000000000002, 1), image3_color = VBase4(0.40999999999999998, 0.40000000000000002, 0.40000000000000002, 1), text = PLocalizer.UpgradeShowPrev, text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_pos = (0, -0.01), text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (0.27500000000000002, 0, -0.94999999999999996), state = DGG.NORMAL, command = self.showPrev)
        self.showPrevButton.hide()
        self.title = DirectLabel(parent = self, relief = None, text = PLocalizer.UpgradeTitle, text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_scale = PiratesGuiGlobals.TextScaleTitleSmall, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (0.23000000000000001, 0, 0.68999999999999995), textMayChange = 1)
        self.upgradeLineTitle = DirectLabel(parent = self.upgradeLine, relief = None, text = PLocalizer.UpgradeLineTitle, text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (0.80000000000000004, 0, -1.8), textMayChange = 0, scale = 3.5)
        ...
        self.previewTitle = DirectLabel(parent = self, relief = None, text = '', text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (0.97999999999999998, 0, 0.53000000000000003), textMayChange = 1)
        self.attributeList = DirectLabel(parent = self, relief = None, text = '', text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ALeft, text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 14, pos = (0.75, 0, 0.45000000000000001), textMayChange = 1)
        self.ownedResourceList = DirectLabel(parent = self, relief = None, text = '', text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ARight, text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG1, text_shadow = PiratesGuiGlobals.TextShadow, pos = (1.27, 0, 0.45000000000000001), textMayChange = 1)
        self.selectHullButton = DirectButton(parent = self, relief = None, image = selectImage, image_scale = (0.22, 1.0, 0.22), image0_color = VBase4(0.65000000000000002, 0.65000000000000002, 0.65000000000000002, 1), image1_color = VBase4(0.40000000000000002, 0.40000000000000002, 0.40000000000000002, 1), image2_color = VBase4(0.90000000000000002, 0.90000000000000002, 0.90000000000000002, 1), image3_color = VBase4(0.40999999999999998, 0.40000000000000002, 0.40000000000000002, 1), text = PLocalizer.UpgradeTypeHull, text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_pos = (0, -0.01), text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (-0.45700000000000002, 0, 0.51000000000000001), state = DGG.NORMAL, command = self.layoutButtons, extraArgs = [
            0])
        self.selectRiggingButton = DirectButton(parent = self, relief = None, image = selectImage, image_scale = (0.22, 1.0, 0.22), image0_color = VBase4(0.65000000000000002, 0.65000000000000002, 0.65000000000000002, 1), image1_color = VBase4(0.40000000000000002, 0.40000000000000002, 0.40000000000000002, 1), image2_color = VBase4(0.90000000000000002, 0.90000000000000002, 0.90000000000000002, 1), image3_color = VBase4(0.40999999999999998, 0.40000000000000002, 0.40000000000000002, 1), text = PLocalizer.UpgradeTypeRigging, text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_pos = (0, -0.01), text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (-0.45700000000000002, 0, 0.41999999999999998), state = DGG.NORMAL, command = self.layoutButtons, extraArgs = [
            1])
        self.selectPatternButton = DirectButton(parent = self, relief = None, image = selectImage, image_scale = (0.22, 1.0, 0.22), image0_color = VBase4(0.65000000000000002, 0.65000000000000002, 0.65000000000000002, 1), image1_color = VBase4(0.40000000000000002, 0.40000000000000002, 0.40000000000000002, 1), image2_color = VBase4(0.90000000000000002, 0.90000000000000002, 0.90000000000000002, 1), image3_color = VBase4(0.40999999999999998, 0.40000000000000002, 0.40000000000000002, 1), text = PLocalizer.UpgradeTypePattern, text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_pos = (0, -0.01), text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (-0.45700000000000002, 0, 0.33200000000000002), state = DGG.NORMAL, command = self.layoutButtons, extraArgs = [
            2])
        self.selectLogoButton = DirectButton(parent = self, relief = None, image = selectImage, image_scale = (0.22, 1.0, 0.22), image0_color = VBase4(0.65000000000000002, 0.65000000000000002, 0.65000000000000002, 1), image1_color = VBase4(0.40000000000000002, 0.40000000000000002, 0.40000000000000002, 1), image2_color = VBase4(0.90000000000000002, 0.90000000000000002, 0.90000000000000002, 1), image3_color = VBase4(0.40999999999999998, 0.40000000000000002, 0.40000000000000002, 1), text = PLocalizer.UpgradeTypeLogo, text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_pos = (0, -0.01), text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (-0.45700000000000002, 0, 0.245), state = DGG.NORMAL, command = self.layoutButtons, extraArgs = [
            3])
        self.selectExitButton = DirectButton(parent = self, relief = None, image = selectImage, image_scale = (0.22, 1.0, 0.22), image0_color = VBase4(0.65000000000000002, 0.65000000000000002, 0.65000000000000002, 1), image1_color = VBase4(0.40000000000000002, 0.40000000000000002, 0.40000000000000002, 1), image2_color = VBase4(0.90000000000000002, 0.90000000000000002, 0.90000000000000002, 1), image3_color = VBase4(0.40999999999999998, 0.40000000000000002, 0.40000000000000002, 1), text = PLocalizer.UpgradeTypeExit, text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_pos = (0, -0.01), text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (-0.45700000000000002, 0, 0.155), state = DGG.NORMAL, command = self.close)
        self.currencyLabels = []
        ciXPos = -0.45000000000000001
        ciZPos = -0.97999999999999998
        ciXSpace = 0.17000000000000001
        ciCount = 0
    ...
    def layOutPatternButtons(self):
        ...
        offX = 0.22500000000000001
        offY = -0.20999999999999999
        countX = 0
        countY = 0
    ...
    def makePatternButton(self, patternType, current = 1):
        ...
        extraArgs = [
            ...
            2,
            patternType]
        patternButton = DirectButton(parent = self, relief = None, image = buttonImage, image_scale = (0.16, 1.0, 0.16), image0_color = VBase4(0.84999999999999998, 0.84999999999999998, 0.84999999999999998, 1), image1_color = VBase4(0.40000000000000002, 0.40000000000000002, 0.40000000000000002, 1), image2_color = VBase4(1.0, 1.0, 1.0, 1), image3_color = VBase4(0.40999999999999998, 0.40000000000000002, 0.40000000000000002, 1), text = shipPatternInfo['Name'], text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_pos = (0, -0.11), text_scale = PiratesGuiGlobals.TextScaleMed, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (0.0, 0, 0.0), command = command, extraArgs = extraArgs)
    ...
    def makeLogoButton(self, logoType, current = 1):
        ...
        extraArgs = [
            ...
            3,
            logoType]
        logoButton = DirectButton(parent = self, relief = None, image = buttonImage, image_scale = (0.16, 1.0, 0.16), image0_color = VBase4(0.84999999999999998, 0.84999999999999998, 0.84999999999999998, 1), image1_color = VBase4(0.40000000000000002, 0.40000000000000002, 0.40000000000000002, 1), image2_color = VBase4(1.0, 1.0, 1.0, 1), image3_color = VBase4(0.40999999999999998, 0.40000000000000002, 0.40000000000000002, 1), text = shipLogoInfo['Name'], text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_pos = (0, -0.11), text_scale = PiratesGuiGlobals.TextScaleMed, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, pos = (0.0, 0, 0.0), command = command, extraArgs = extraArgs)
        if buttonGeom:
    ...
    def makeHullButton(self, hullType, current = 1, downgrade = False, sidegrade = False, isCurrentType = False):
        ...
        shipButton = DirectButton(parent = self, relief = None, image = buttonImage, image_scale = imageScale, image0_color = VBase4(0.80000000000000004, 0.80000000000000004, 0.80000000000000004, 1), image1_color = VBase4(0.40000000000000002, 0.40000000000000002, 0.40000000000000002, 1), image2_color = VBase4(1.0, 1.0, 1.0, 1), image3_color = VBase4(0.40000000000000002, 0.40000000000000002, 0.40000000000000002, 1), text = text, text_font = PiratesGlobals.getPirateBoldOutlineFont(), text_align = TextNode.ACenter, text_pos = (0.055, -0.065000000000000002), text_scale = textSize, text_fg = textColor, text_shadow = PiratesGuiGlobals.TextShadow, pos = (0.0, 0, 0.0), command = command, extraArgs = extraArgs)
        if isCurrentType:
    ...
    def previewShip(self, shipType, hullMaterial = None, sailMaterial = None, sailPattern = None, logo = None, invertLogo = False):
        ...
        self.shipModel.setPos(0.14999999999999999, 0.0, -0.14999999999999999)
    ...
    def confirmPurchase(self):
        ...
        if self.previewCat != None and self.previewValue != None:
            ...
            self.confirmPanel.setPos(0, 0, -0.20000000000000001)
        

    
    def panelConfirmOkay(self):
        localAvatar.sendUpdate('requestShipUpgrade', [
            self.shipId,
            self.previewCat,
            self.previewValue])
    ...
    def checkConfirmButtonState(self):
        ...
        if self.waitingForUpgrade and self.viewingCurrent or self.tooExpensive:
