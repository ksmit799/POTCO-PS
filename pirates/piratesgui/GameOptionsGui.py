...
class GameOptionsGui(DirectFrame):
    ...
    def setupAudioFrame(self):
        ...
        self.create_label(x, y, text, parent, 1.2)
        x += 0.38
        self.firstMateCheck = CheckButton(parent = parent, relief = None, scale = 0.40000000000000002, pos = (x, 0, y + 0.014999999999999999), command = self.firstMateCheckCB)
    ...
    def setupInterfaceFrame(self):
        ...
        self.create_label(x, y, text, parent, sl)
        self.shipLookCheck = CheckButton(parent = parent, relief = None, scale = sc, pos = (x + 0.35999999999999999, 0, y + 0.014999999999999999), command = self.shipLookCheckCB)
        y += oy
