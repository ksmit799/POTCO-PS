...
class TradeOfferFrame(DirectFrame):
    ...
    def __init__(self, avName, w, h, isLocal, tradePanel):
        ...
        self.itemsLabel = DirectLabel(parent = self, relief = None, text = 'No items', text_scale = PiratesGuiGlobals.TextScaleSmall, text_align = TextNode.ALeft, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_wordwrap = 11, pos = (0.02, 0, h - 0.20000000000000001), textMayChange = 1)
        if self.isLocal:
            self.goldButton = DirectButton(parent = self, relief = DGG.RAISED, borderWidth = PiratesGuiGlobals.BorderWidthSmall, frameSize = (0, w - 0.040000000000000001, 0, 0.040000000000000001), pos = (0.02, 0, h - 0.10000000000000001), text = 'Add 1 Gold', text_scale = PiratesGuiGlobals.TextScaleSmall, text_align = TextNode.ALeft, text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, text_pos = (0.029999999999999999, 0.01), frameColor = PiratesGuiGlobals.ButtonColor2, command = self.tradePanel.addGold)
