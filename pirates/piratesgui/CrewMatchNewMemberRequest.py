...
class CrewMatchNewMemberRequest(DirectFrame):
    ...
    def __init__(self, avId, avName, crewType, openCrew):
        ...
        nameArray = ('\x01CPOrangeHEAD\x01' + self.avName + '\x02', '\x01CPOrangeHEAD\x01' + self.avName + '\x02', '\x1CPOrangeOVER\x01' + self.avName + '\x02', '\x01CPOrangeHEAD\x01' + self.avName + '\x02')
