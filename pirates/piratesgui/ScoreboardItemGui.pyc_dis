...
class ScoreboardItemGui(DirectFrame):
    ...
    def __init__(self, item, width, height, parent = None, **kw):
        ...
        self.icons = {
            ItemId.CARGO_CRATE: ('icon_crate', 'models/gui/toplevel_gui', PLocalizer.Crate),
            ItemId.CARGO_CHEST: ('icon_chest', 'models/textureCards/icons', PLocalizer.Chest),
            ItemId.CARGO_SKCHEST: ('topgui_icon_ship_chest03', 'models/textureCards/icons', PLocalizer.SkChest),
            ItemId.WHEAT: ('icon_wheat', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.WHEAT)),
            ItemId.COTTON: ('icon_cotton', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.COTTON)),
            ItemId.RUM: ('icon_rum', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.RUM)),
            ItemId.IRON_ORE: ('icon_ironore', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.IRON_ORE)),
            ItemId.IVORY: ('icon_ivory', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.IVORY)),
            ItemId.SILK: ('icon_silk', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.SILK)),
            ItemId.SPICES: ('icon_spices', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.SPICES)),
            ItemId.COPPER_BARS: ('icon_copperbars', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.COPPER_BARS)),
            ItemId.SILVER_BARS: ('icon_silverbars', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.SILVER_BARS)),
            ItemId.GOLD_BARS: ('icon_goldbars', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.GOLD_BARS)),
            ItemId.EMERALDS: ('icon_emeralds', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.EMERALDS)),
            ItemId.RUBIES: ('icon_rubies', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.RUBIES)),
            ItemId.DIAMONDS: ('icon_diamonds', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.DIAMONDS)),
            ItemId.CURSED_COIN: ('icon_cursedcoin', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.CURSED_COIN)),
            ItemId.ARTIFACT: ('icon_artifact', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.ARTIFACT)),
            ItemId.RELIC: ('icon_relic', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.RELIC)),
            ItemId.RARE_DIAMOND: ('icon_rarediamond', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.RARE_DIAMOND)),
            ItemId.CROWN_JEWELS: ('icon_crownjewels', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.CROWN_JEWELS)),
            ItemId.RAREITEM6: ('icon_rareitem6', 'models/textureCards/icons', PLocalizer.InventoryTypeNames.get(ItemId.RAREITEM6)) }
        self.item = item
        self.revealTime = 0
        self.counter = None
        self.valueText = None
    ...
    def _createIface(self):
        ...
        if self.item.get('Type') == 'Title':
            ...
            self.descText['geom'] = self.getGoldIcon()
            self.descText['geom_scale'] = 0.28000000000000003 * self.height * 10
            self.descText['geom_pos'] = (0.050000000000000003, 0, 0.01)
            self.descText['text_pos'] = (0.23999999999999999, 0, 0)
            self.descText['text'] = itemName
            self.descText['text_fg'] = PiratesGuiGlobals.TextFG2
            ...
            self.descText['geom_scale'] = 0.080000000000000002 * self.height * 10
            self.descText['geom_pos'] = (0.050000000000000003, 0, 0.01)
            self.descText['text_pos'] = (0.23999999999999999, 0, 0)
            self.descText['text'] = itemName
            self.descText['text_fg'] = PiratesGuiGlobals.TextFG2
