...
class TreasureMapRulesPanel:
    ...
    def load(self, parent = None):
        ...
        self.panelTitleText = DirectLabel(parent = self.frame, relief = None, text = self.panelTitle, text_scale = 0.07, text_align = TextNode.ACenter, text_font = PiratesGlobals.getPirateFont(), text_fg = PiratesGuiGlobals.TextFG1, text_shadow = (0, 0, 0, 1), pos = (0, 0, 0.025))
        self.instructionsText = DirectLabel(parent = self.frame, relief = None, text = self.instructions, text_scale = 0.05, text_align = TextNode.ACenter, text_wordwrap = 40, text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1), pos = (0, 0, -0.03))
        self.frame.stash()
