...
class BranchMenuGUI(DirectFrame):
    ...
    def __init__(self, offer, callback = None, descriptionCallback = None):
        DirectFrame.__init__(self, relief = None, pos = (0.80000000000000004, 0, -0.65000000000000002))
