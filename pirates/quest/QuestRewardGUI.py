...
class QuestRewardGUI(QuestDetailBase):
    ...
    def buildIvals(self):
        self.questCompleteScaleSeq = Sequence(LerpScaleInterval(self.questComplete, 1.0, scale = 0.044999999999999998), LerpScaleInterval(self.questComplete, 1.0, scale = PiratesGuiGlobals.TextScaleLarge))
        self.colorChangeParallel = Parallel()
        self.showIval = Sequence(Parallel(LerpPosInterval(self, 0.29999999999999999, pos = Point3(-0.46999999999999997, 0, 0.52000000000000002), blendType = 'easeOut'), LerpPosInterval(self.questComplete, 0.29999999999999999, pos = Point3(-0.25, 0, 0.13), blendType = 'easeOut')), LerpScaleInterval(self.questComplete, 0.5, scale = PiratesGuiGlobals.TextScaleLarge, blendType = 'easeOut'), Wait(1.0))
        if self.showLevelUp:
    ...
    def showPanelAnimations(self):
        ...
        if self.reputation and not (self.gameGui.repMeter.mastered):
            if self.gameGui.repMeter.changeMeter.meterFaceHalf2.getColor() == self.gameGui.repMeter.changeMeter['meterColor2']:
                self.colorChangeParallel.append(Sequence(LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf2, 0.10000000000000001, color = Vec4(1, 1, 1, 1)), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf2, 0.10000000000000001, color = self.gameGui.repMeter.changeMeter['meterColor2']), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf2, 0.10000000000000001, color = Vec4(1, 1, 1, 1)), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf2, 0.10000000000000001, color = self.gameGui.repMeter.changeMeter['meterColor2']), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf2, 0.10000000000000001, color = Vec4(1, 1, 1, 1)), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf2, 0.10000000000000001, color = self.gameGui.repMeter.changeMeter['meterColor2']), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf2, 0.10000000000000001, color = Vec4(1, 1, 1, 1)), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf2, 0.10000000000000001, color = self.gameGui.repMeter.changeMeter['meterColor2']), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf2, 0.10000000000000001, color = Vec4(1, 1, 1, 1)), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf2, 0.40000000000000002, color = self.gameGui.repMeter.changeMeter['meterColor'])))
            
            if self.gameGui.repMeter.changeMeter.meterFaceHalf3.getColor() == self.gameGui.repMeter.changeMeter['meterColor2']:
                self.colorChangeParallel.append(Sequence(LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf3, 0.10000000000000001, color = Vec4(1, 1, 1, 1)), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf3, 0.10000000000000001, color = self.gameGui.repMeter.changeMeter['meterColor2']), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf3, 0.10000000000000001, color = Vec4(1, 1, 1, 1)), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf3, 0.10000000000000001, color = self.gameGui.repMeter.changeMeter['meterColor2']), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf3, 0.10000000000000001, color = Vec4(1, 1, 1, 1)), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf3, 0.10000000000000001, color = self.gameGui.repMeter.changeMeter['meterColor2']), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf3, 0.10000000000000001, color = Vec4(1, 1, 1, 1)), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf3, 0.10000000000000001, color = self.gameGui.repMeter.changeMeter['meterColor2']), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf3, 0.10000000000000001, color = Vec4(1, 1, 1, 1)), Wait(0.20000000000000001), LerpColorInterval(self.gameGui.repMeter.changeMeter.meterFaceHalf3, 0.40000000000000002, color = self.gameGui.repMeter.changeMeter['meterColor'])))
    ...
    def showLevelUpAlert(self):
        self.popupSfx.play()
        self.gameGui.createLevelUpAlert(4.0, Vec3(0.68999999999999995, 0.0, -0.5), Vec3(0.0, 0.0, 0.25))

    
    def showExpAlert(self):
        self.popupSfx.play()
        self.gameGui.createExpAlert(self.reputation, 8.0, Vec3(0.68999999999999995, 0.0, -0.5), Vec3(0.0, 0.0, 0.25))
    ...
    def setQuestInfoFromQuest(self, quest):
        ...
        self['text'] = text
        self.gameGui = GameGui.GameGui(self, relief = None, state = DGG.DISABLED, scale = 0.59999999999999998, pos = (-0.45000000000000001, 0, -0.12))
