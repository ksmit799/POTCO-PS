...
class CutsceneActor:
    ...
    getActorKey = staticmethod(getActorKey)
...
class CutShip(CutsceneActor):
    ...
    getActorKey = classmethod(getActorKey)
...
class CutLocalPirate(CutsceneActor):
    ...
    def finishCutscene(self):
        ...
        if hasattr(self.localAvatar, 'gameFSM'):
            ...
            if self.oldParams.gameState == 'EnterTunnel' and self.oldParams.gameState == 'DoorInteract' or self.oldParams.gameState == 'TeleportOut':
