...
HOLIDAYS_WITH_CATALOGS = [SAINTPATRICKSDAY,
 VALENTINESDAY,
 WINTERFESTIVAL,
 MARDIGRAS,
 HALLOWEEN,
...
def getHolidayRestartable(holidayId):
    return (holidayId not in [INVASIONPORTROYAL,
     INVASIONTORTUGA,
     INVASIONDELFUEGO])
...
holidayNameDict = {DOUBLEGOLDHOLIDAY: 'DoubleGoldHolidayAll',
...
holidayClassNameDict = {FLEETHOLIDAY: 'FleetHoliday',
...
def getAllHolidayIds():
    ...
    for holidayClass in holidayNameDict.iterkeys():
        ...
        if isinstance(entry, type({})):
            ...
            allHolidayIds.append(getHolidayId(holidayClass, ))
...
def getAllHolidayNames():
    ...
    for holidayName in holidayNameDict.values():
        if (isinstance(holidayName, type({})) and allHolidayNames.extend(holidayName.values())):
            pass
...
def getHolidayIdFromName(holidayName):
    ...
    for holidayClass in holidayNameDict.iterkeys():
        ...
        if isinstance(entry, type({})):
            ...
            return getHolidayId(holidayClass, )
...
holidaySchedules = {DOUBLEGOLDHOLIDAY: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2008,
                      Month.SEPTEMBER,
                      13,
                      12,
                      0,
                     ...
                     (2008,
                      ...
                      0,
                      0)]),
 DOUBLEGOLDHOLIDAYPAID: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2008,
                          Month.SEPTEMBER,
                          14,
                          12,
                          0,
                         ...
                         (2008,
                          ...
                          0,
                          0)]),
 DOUBLEXPHOLIDAY: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2009,
                    Month.DECEMBER,
                    19,
                    12,
                    0,
                   ...
                   (2009,
                    ...
                    0,
                    0)]),
 DOUBLEXPHOLIDAYPAID: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2009,
                        Month.DECEMBER,
                        20,
                        12,
                        0,
                       ...
                       (2009,
                        ...
                        0,
                        0)]),
 DOUBLELOOTHOLIDAY: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2008,
                      Month.SEPTEMBER,
                      13,
                      12,
                      0,
                     ...
                     (2008,
                      ...
                      0,
                      0)]),
 FREEHATWEEK: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2008,
                Month.FEBRUARY,
                25,
                0,
                0,
               ...
               (2008,
                ...
                0,
                0)]),
 SAINTPATRICKSDAY: HolidayDates(HolidayDates.TYPE_YEARLY, [(Month.MARCH,
                     2,
                     0,
                     0,
                     0),
                    (Month.MARCH,
                     ...
                     0,
                     0)]),
 APRILFOOLS: HolidayDates(HolidayDates.TYPE_YEARLY, [(Month.APRIL,
               1,
               0,
               0,
               0),
              (Month.APRIL,
               ...
               0,
               0)]),
 MOTHERSDAY: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2009,
               Month.MAY,
               6,
               0,
               0,
              ...
              (2009,
               ...
               0,
               0)]),
 QUEENANNES: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2011,
               Month.MAY,
               16,
               0,
               0,
              ...
              (2011,
               ...
               0,
               0)]),
 FATHERSDAY: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2009,
               Month.JUNE,
               17,
               0,
               0,
              ...
              (2009,
               ...
               0,
               0)]),
 FOURTHOFJULY: HolidayDates(HolidayDates.TYPE_YEARLY, [(Month.JULY,
                 3,
                 18,
                 0,
                 0),
                (Month.JULY,
                 ...
                 0,
                 0)]),
 GETCONNNECTED: HolidayDates(HolidayDates.TYPE_YEARLY, [(Month.JULY,
                  1,
                  0,
                  0,
                  0),
                 (Month.AUGUST,
                  ...
                  0,
                  0)]),
 HALFOFFCUSTOMIZATION: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2008,
                         Month.AUGUST,
                         14,
                         0,
                         0,
                        ...
                        (2008,
                         ...
                         0,
                         0)]),
 ALLACCESSWEEKEND: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2009,
                     Month.APRIL,
                     17,
                     0,
                     0,
                    ...
                    (2009,
                     ...
                     0,
                     0)]),
 HALLOWEEN: HolidayDates(HolidayDates.TYPE_YEARLY, [(Month.OCTOBER,
              15,
              0,
              0,
              0),
             (Month.OCTOBER,
              ...
              0,
              0)]),
 JOLLYROGERCURSE: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2010,
                    Month.OCTOBER,
                    15,
                    16,
                    0,
                   ...
                   (2010,
                    ...
                    20,
                    0)]),
 FOUNDERSFEAST: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2009,
                  Month.NOVEMBER,
                  21,
                  0,
                  0,
                 ...
                 (2009,
                  ...
                  0,
                  0)]),
 FREEITEMTHANKSGIVING: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2008,
                         Month.NOVEMBER,
                         27,
                         3,
                         0,
                        ...
                        (2008,
                         ...
                         0,
                         0)]),
 CURSEDNIGHT: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2009,
                Month.OCTOBER,
                12,
                0,
                0,
               ...
               (2009,
                ...
                0,
                0)]),
 JOLLYCURSEAUTO: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2008,
                   Month.DECEMBER,
                   12,
                   12,
                   0,
                  ...
                  (2008,
                   ...
                   0,
                   0)]),
 WINTERFESTIVAL: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2009,
                   Month.DECEMBER,
                   17,
                   0,
                   0,
                  ...
                  (2010,
                   ...
                   0,
                   0)]),
 NEWYEARS: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2009,
             Month.DECEMBER,
             31,
             0,
             0,
            ...
            (2010,
             ...
             0,
             0)]),
 VALENTINESDAY: HolidayDates(HolidayDates.TYPE_YEARLY, [(Month.FEBRUARY,
                  10,
                  0,
                  0,
                  0),
                 (Month.FEBRUARY,
                  ...
                  0,
                  0)]),
 ZOMBIEEMOTE: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2010,
                Month.OCTOBER,
                1,
                0,
                0,
 ...
 INVASIONTORTUGA: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2009,
                    Month.DECEMBER,
                    11,
                    14,
                    0,
 ...
 INVASIONDELFUEGO: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2010,
                     Month.JANUARY,
                     21,
                     12,
                     0,
 ...
 DOUBLECROSS: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2010,
                Month.FEBRUARY,
                26,
                0,
                0,
               ...
               (2010,
                ...
                0,
                0)]),
 MARDIGRAS: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2010,
              Month.FEBRUARY,
              11,
              0,
              0,
             ...
             (2010,
              ...
              0,
              0)]),
 FEASTOFSTRENGTH: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2010,
                    Month.JANUARY,
                    23,
                    0,
                    0,
                   ...
                   (2010,
                    ...
                    0,
                    0)]),
 EITCMOBILIZATION: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2010,
                     Month.MARCH,
                     5,
                     0,
                     0,
                    ...
                    (2010,
                     ...
                     0,
                     0)]),
 NAVYMOBILIZATION: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2010,
                     Month.JANUARY,
                     2,
                     0,
                     0,
                    ...
                    (2010,
                     ...
                     0,
                     0)]),
 SKELMOBILIZATION: HolidayDates(HolidayDates.TYPE_CUSTOM, [(2010,
                     Month.OCTOBER,
                     22,
                     0,
                     0,
...
RandomizedSchedules = {'Invasions': {'configs': [('want-random-invasions',
                            1),
                           ('use-path-finding',
                            0)],
               'holidayIds': [INVASIONPORTROYAL,
                              INVASIONTORTUGA,
                              INVASIONDELFUEGO],
               'idOverrideDates': {INVASIONPORTROYAL: [((2010,
                                                         2,
                                                         4),
                                                        (2010,
                                                         2,
               ...
               'daysPerMonth': (5,
                                8),
               'numPerDay': 3,
               'timeWindows': [RandomTimeWindows.E,
                               RandomTimeWindows.F,
                               RandomTimeWindows.G],
               'duration': (1,
                            45)},
 'TreasureFleets': {'configs': [('want-random-treasurefleets',
                                 1)],
                    'holidayIds': [getHolidayId(FLEETHOLIDAY, FHConfigs.TF_EITC_RAND_KH_P_E_SW_S_W),
                                   getHolidayId(FLEETHOLIDAY, FHConfigs.TF_NAVY_RAND_KH_P_E_SW_S_W)],
                    'idOverrideDates': {getHolidayId(FLEETHOLIDAY, FHConfigs.TF_EITC_RAND_KH_P_E_SW_S_W): [((2010,
                                                                                                             1,
                                                                                                             1),
                                                                                                            (2010,
                                                                                                             4,
...
def getHolidayMsgs(holidayId):
    ...
    if (holidayMsgs and holidayConfig):
        holidayMsgs = holidayMsgs.get(holidayConfig, holidayMsgs.get())
    return holidayMsgs
...
def getHolidayStartMsg(holidayId, paidStatus, chat = 0):
    ...
    if holidayMsgs:
        if holidayMsgs.has_key(MSG_START_ALL):
            ...
            if (holidayMsgs.has_key(MSG_START_UNLIMITED) and paidStatus):
...
def getHolidayEndMsg(holidayId, paidStatus, chat = 0):
    ...
    if holidayMsgs:
        if holidayMsgs.has_key(MSG_END_ALL):
            ...
            if (holidayMsgs.has_key(MSG_END_UNLIMITED) and paidStatus):
...
def getHolidayStatusMsg(holidayId, paidStatus):
    ...
    if holidayMsgs:
        if holidayMsgs.has_key(MSG_CHAT_STATUS):
            ...
            if (holidayMsgs.has_key(MSG_CHAT_STATUS_UNLIMITED) and paidStatus):
