...
class DistributedCrewMatchManager(DistributedObjectGlobal):
    ...
    d_requestTeleportQuery = report(types = [
        'deltaStamp',
        'args'], dConfigParam = 'teleport')(d_requestTeleportQuery)
    ...
    d_requestTeleportResponse = report(types = [
        'deltaStamp',
        'args'], dConfigParam = 'teleport')(d_requestTeleportResponse)
