...
ShipLogoNames = {
    ...
    ShipGlobals.Logos.Player_Hawk: 'PIRATE: HAWK',
    ShipGlobals.Logos.Player_Rose: 'PIRATE: ROSE',
    ShipGlobals.Logos.Player_Flame: 'PIRATE: FLAME',
    ShipGlobals.Logos.Player_SpanishBull: 'PIRATE: BULL',
    ShipGlobals.Logos.Player_Wolf: 'PIRATE: WOLF',
    ShipGlobals.Logos.Player_Angel: 'PIRATE: ANGEL',
    ShipGlobals.Logos.Player_Dragon: 'PIRATE: DRAGON',
    ShipGlobals.Logos.Player_Shield: 'PIRATE: SHIELD',
    ShipGlobals.Logos.Player_Heart: 'PIRATE: HEART',
...
InventoryTypeNames = {
    ...
    ItemId.HUNTER_VENGEANCE: ShipClassNames.get(ShipGlobals.HUNTER_VENGEANCE),
...
ItemNames = {
    ...
    ItemGlobals.SCIMITAR_42: "Viper's Kiss",
    ItemGlobals.SCIMITAR_46: 'Desert Claw',
    ItemGlobals.SCIMITAR_47: 'Scimitar 47',
    ItemGlobals.SCIMITAR_48: 'Scimitar 48',
    ...
    ItemGlobals.CURSED_BLADE_47: 'Lost Blade of Leviathan',
    ...
    ItemGlobals.MERCHANT_SPYGLASS: "Merchant's Spyglass",
    ...
    ItemGlobals.MERCHANT_SEA_CHART: "Merchant's Sea Chart",
    ...
    ItemGlobals.POTION_SUMMON_MONKEY: 'Summon Monkey',
    ItemGlobals.POTION_SUMMON_WASP: 'Summon Wasp',
    ItemGlobals.POTION_SUMMON_DOG: 'Summon Dog',
    ...
    ItemGlobals.BARON_WING_HAT: "Baron's Hat",
    ItemGlobals.PRINCE_WING_HAT: "Prince's Hat",
    ItemGlobals.ROGUE_PRIVATEER_WING_HAT: 'Rogue Privateer Hat',
    ...
    ItemGlobals.BARONESS_HAT: 'Baroness Hat',
    ItemGlobals.PRINCE_LADY_HAT: "Prince's Hat",
    ItemGlobals.ROGUE_PRIVATEER_CAVALRY_HAT: 'Rogue Privateer Hat',
    ...
    ItemGlobals.ROSE_BUCCANEER_HAT: 'Rose Buccaneer Hat',
    ItemGlobals.FRENCH_ASSASSIN_HAT: 'French Assassin Hat',
    ItemGlobals.DIPLOMAT_HAT: 'Diplomat Hat',
    ItemGlobals.SEA_SERPENT_HUNTER_HAT: 'Sea Serpent Hat',
    ItemGlobals.PEACOCK_TRICORN_HAT: 'Peacock Hat',
    ItemGlobals.SCOURGE_TRICORN_HAT: 'Scourge of the Seas Hat',
    ItemGlobals.ZOMBIE_PIRATE_HAT: 'Zombie Pirate Hat',
    ItemGlobals.ZOMBIES_PIRATE_HAT: "Zombie Pirate's Hat",
    ItemGlobals.SOUTH_CHINA_BAND: 'China Seas Warrior Bandana',
    ItemGlobals.WILDFIRE_BAND: 'Wildfire Bandana',
    ItemGlobals.BOUNTYHUNTER_BAND: 'Bounty Hunter Bandana',
    ItemGlobals.BARBARY_CORSAIR_BAND: 'Barbary Corsair Bandana',
    ...
    ItemGlobals.FRENCH_ASSASSIN_LONG_COAT: 'French Assassin Long Coat',
    ItemGlobals.BARON_LONG_COAT: 'Baron Long Coat',
    ItemGlobals.PRINCE_LONG_COAT: 'Prince Long Coat',
    ItemGlobals.SCOURGE_LONG_COAT: 'Scourge of the Seas Coat',
    ItemGlobals.WILDIFRE_LONG_COAT: 'Wildfire Long Coat',
    ItemGlobals.ZOMBIE_PIRATE_LONG_COAT: 'Zombie Pirate Coat',
    ItemGlobals.ZOMBIES_PIRATE_LONG_COAT: "Zombie Pirate's Coat",
    ItemGlobals.ROGUE_PRIVATEER_LONG_COAT: 'Rogue Privateer Coat',
    ItemGlobals.SEA_SERPENT_JACKET: 'Sea Serpent Jacket',
    ItemGlobals.CHINA_WARRIOR_COAT: 'China Seas Warrior Coat',
    ItemGlobals.DIPLOMAT_COAT: 'Diplomat Long Coat',
    ItemGlobals.BROWN_STRIPE_JACKET: 'Brown Stripe Coat',
    ItemGlobals.BLACK_CHECKERBOARD_JACKET: 'Checker Coat',
    ...
    ItemGlobals.FRENCH_ASSASSIN_FROCK_COAT: 'French Assassin Frock Coat',
    ...
    ItemGlobals.BARONESS_FROCK_COAT: 'Baroness Coat',
    ItemGlobals.DIPLOMAT_FROCK_COAT: 'Diplomat Coat',
    ItemGlobals.PRINCE_FROCK_COAT: 'Prince Coat',
    ItemGlobals.CHINA_WARROIR_CLOSED_LADY_COAT: 'China Seas Warrior Coat',
    ItemGlobals.ROGUE_PRIVATEER_FROCK_COAT: 'Rogue Privateer Coat',
    ItemGlobals.SCOURGE_FROCK_COAT: 'Scourge of the Seas Coat',
    ItemGlobals.SEA_SERPENT_FROCK_COAT: 'Sea Serpent Coat',
    ItemGlobals.ZOMBIE_PIRATE_FROCK_COAT: 'Zombie Pirate Coat',
    ItemGlobals.ZOMBIES_PIRATE_FROCK_COAT: "Zombie Pirate's Coat",
    ...
    ItemGlobals.BOUNTYHUNTER_VEST: 'Bounty Hunter Vest',
    ItemGlobals.ROGUE_PRIVATEER_VEST: 'Rogue Privateer Vest',
    ItemGlobals.WILDFIRE_VEST: 'Wildfire Vest',
    ...
    ItemGlobals.PEACOCK_CORSET: 'Peacock Corset',
    ItemGlobals.ZOMBIE_PIRATE_CORSET: 'Zombie Pirate Corset',
    ItemGlobals.ZOMBIES_PIRATE_CORSET: "Zombie Pirate's Corset",
    ItemGlobals.BOUNTYHUNTER_CORSET: 'Bounty Hunter Corset',
    ItemGlobals.ROGUE_PRIVATEER_CORSET: 'Rogue Privateer Corset',
    ItemGlobals.WILDFIRE_CORSET: 'Wildfire Corset',
    ItemGlobals.PRINCE_VEST: 'Prince Vest',
    ...
    ItemGlobals.CHINESE_NEWYEAR_SHIRT: 'Snapdragon Shirt',
    ...
    ItemGlobals.HIGHNECK_FRENCH_ASSASSIN_SHIRT: 'French Assassin Shirt',
    ItemGlobals.SCOURGE_TANK: 'Scourge of the Seas Tank',
    ItemGlobals.SEA_SERPENT_TANK: 'Sea Serpent Tank',
    ItemGlobals.ZOMBIE_LONG_SLEEVE: 'Zombie Shirt',
    ItemGlobals.ZOMBIES_LONG_SLEEVE: "Zombie's Shirt",
    ItemGlobals.HIGHNECK_BARON_SHIRT: 'Baron Shirt',
    ItemGlobals.HIGHNECK_PEACOCK_SHIRT: 'Peacock Shirt',
    ItemGlobals.HIGHNECK_PRINCE_SHIRT: 'Prince Shirt',
    ItemGlobals.BARBARY_CORSAIR_SHIRT: 'Barbary Corsair Shirt',
    ...
    ItemGlobals.SCOURGE_BLOUSE: 'Scourge of the Seas Blouse',
    ItemGlobals.SEA_SERPENT_BLOUSE: 'Sea Serpent Blouse',
    ...
    ItemGlobals.FRENCH_ASSASSIN_TOP: 'French Assassin Top',
    ItemGlobals.BARBARY_CORSAIR_TOP: 'Barbary Corsair Top',
    ...
    ItemGlobals.CHINESE_NEWYEAR_BLOUSE: 'Snapdragon Blouse',
    ...
    ItemGlobals.DIPLOMAT_BLOUSE: 'Diplomat Blouse',
    ItemGlobals.PRINCE_BLOUSE: 'Prince Blouse',
    ItemGlobals.BARONESS_BLOUSE: 'Baroness Blouse',
    ...
    ItemGlobals.PRINCE_SASH: 'Prince Sash',
    ...
    ItemGlobals.FRENCH_ASSASSIN_SASH: 'French Assassin Sash',
    ItemGlobals.BOUNTYHUNTER_SASH: 'Bounty Hunter Sash',
    ItemGlobals.BARBARY_CORSAIR_SASH: 'Barbary Corsair Sash',
    ItemGlobals.PEACOCK_SASH_MALE: "Peacock Men's Sash",
    ItemGlobals.PEACOCK_SASH_FEMALE: "Peacock Lady's Sash",
    ItemGlobals.WILDFIRE_SASH_FEMALE: 'Wildfire Sash',
    ItemGlobals.ROGUE_PRIVATEER_BELT: 'Rogue Privateer Belt',
    ItemGlobals.SCOURGE_BELT: 'Scourge of the Seas Belt',
    ItemGlobals.SEA_SERPENT_BELT: 'Sea Serpent Belt',
    ItemGlobals.ZOMBIE_PIRATE_BELT: 'Zombie Pirate Belt',
    ItemGlobals.ZOMBIES_PIRATE_BELT: "Zombie Pirate's Belt",
    ...
    ItemGlobals.FRENCH_ASSASSIN_BREECHES: 'French Assassin Breeches',
    ItemGlobals.BARON_BREECHES: 'Baron Breeches',
    ItemGlobals.BOUNTYHUNTER_BREECHES: 'Bounty Hunter Breeches',
    ItemGlobals.CHINA_WARRIOR_BREECHES: 'China Seas Warrior Breeches',
    ItemGlobals.DIPLOMAT_BREECHES: 'Diplomat Breeches',
    ItemGlobals.PEACOCK_BREECHES: 'Peacock Breeches',
    ItemGlobals.PRINCE_BREECHES: 'Prince Breeches',
    ItemGlobals.ROGUE_PRIVATEER_BREECHES: 'Rogue Breeches',
    ItemGlobals.SEA_SERPENT_BREECHES: 'Sea Serpent Breeches',
    ItemGlobals.ZOMBIE_PIRATE_BREECHES: 'Zombie Pirate Breeches',
    ItemGlobals.ZOMBIES_PIRATE_BREECHES: "Zombie Pirate's Breeches",
    ItemGlobals.BARBARY_CORSAIR_TROUSERS: 'Barbary Corsair Trousers',
    ItemGlobals.SCOURGE_TROUSERS: 'Scourge of the Seas Trousers',
    ItemGlobals.WILDFIRE_TROUSERS: 'Wildfire Trousers',
    ...
    ItemGlobals.FRENCH_ASSASSIN_CAPRIS: 'French Assassin Capris',
    ItemGlobals.BOUNTYHUNTER_SHORTS: 'Bounty Hunter Short',
    ItemGlobals.BARBARY_CORSAIR_SHORTS: 'Barbary Corsair Shorts',
    ItemGlobals.PEACOCK_SKIRT: 'Peacock Skirt',
    ItemGlobals.PRINCE_SKIRT: 'Prince Skirt',
    ItemGlobals.WILDFIRE_SKIRT: 'Wildfire Skirt',
    ItemGlobals.BARONESS_CAPRIS: 'Baroness Capris',
    ItemGlobals.CHINA_WARRIOR_CAPRIS: 'China Seas Warrior Capris',
    ItemGlobals.DIPLOMAT_CAPRIS: 'Diplomat Capris',
    ItemGlobals.ROGUE_PRIVATEER_CAPRIS: 'Rogue Privateer Capris',
    ItemGlobals.SCOURGE_CAPRIS: 'Scourge of the Seas Capris',
    ItemGlobals.SEA_SERPENT_CAPRIS: 'Sea Serpent Capris',
    ItemGlobals.ZOMBIE_PIRATE_CAPRIS: 'Zombie Pirate Capris',
    ItemGlobals.ZOMBIES_PIRATE_CAPRIS: "Zombie Pirate's Capris",
    ...
    ItemGlobals.RAVEN_TALL_BOOTS: 'Raven Boots',
    ItemGlobals.FRENCH_ASSASSIN_BOOTS: 'French Assassin Boots',
    ItemGlobals.CHINA_WARRIOR_TALL_BOOTS: 'China Seas Warrior Boots',
    ItemGlobals.PEACOCK_TALL_BOOTS: 'Peacock Boots',
    ItemGlobals.SEA_SERPENT_TALL_BOOTS: 'Sea Serpent Boots',
    ItemGlobals.BOUNTYHUNTER_BOOTS: 'Bounty Hunter Boots',
    ItemGlobals.BARBARY_CORSAIR_BOOTS: 'Barbary Corsair Boots',
    ItemGlobals.ROGUE_PRIVATEER_BOOTS: 'Rogue Privateer Boots',
    ItemGlobals.SCOURGE_BOOTS: 'Scourge of the Seas Boots',
    ItemGlobals.WILDFIRE_BOOTS: 'Wildfire Boots',
    ItemGlobals.ZOMBIE_PIRATE_BOOTS: 'Zombie Pirate Boots',
    ItemGlobals.ZOMBIES_PIRATE_BOOTS: "Zombie Pirate's Boots",
    ItemGlobals.BARON_BOOTS: 'Baron Boots',
    ItemGlobals.DIPLOMAT_SHOES: 'Dipolmat Shoes',
    ItemGlobals.PRINCE_SHOES: 'Prince Shoes',
    ItemGlobals.VOYAGER_BOOTS: 'Voyager Boots',
    ItemGlobals.MAYOR_BOOTS: 'Mayor Boots',
    ItemGlobals.GOLD_TRIM_BOOTS: 'Gold Trim Boots',
    ItemGlobals.RED_TRIM_BOOTS: 'Red Trim Boots',
    ...
    ItemGlobals.BARONESS_SHORT_BOOTS: 'Baroness Boots',
    ItemGlobals.ROGUE_PRIVATEER_SHORT_BOOTS: 'Rogue Privateer Boots',
    ItemGlobals.FRENCH_ASSASSIN_KNEE_BOOTS: 'French Assassin Boots',
    ItemGlobals.PEACOCK_KNEE_BOOTS: 'Peacock Boots',
    ItemGlobals.SCOURGE_KNEE_BOOTS: 'Scourge Boots',
    ItemGlobals.WILDFIRE_KNEE_BOOTS: 'Wildfire Boots',
    ItemGlobals.ZOMBIE_PIRATE_KNEE_BOOTS: 'Zombie Pirate Boots',
    ItemGlobals.ZOMBIES_PIRATE_KNEE_BOOTS: "Zombie Pirate's Boots",
    ItemGlobals.BOUNTYHUNTER_LADY_TALL_BOOTS: 'Bounty Hunter Boots',
    ItemGlobals.CHINA_WARRIOR__LADY_TALL_BOOTS: 'China Seas Warrior Boots',
    ItemGlobals.BARBARY_CORSAIR_LADY_TALL_BOOTS: 'Barbary Corsair Boots',
    ItemGlobals.SEA_SERPENT_LADY_TALL_BOOTS: 'Sea Serpent Boots',
    ItemGlobals.DIPLOMAT_SHORT_BOOTS: 'Diplomat Boots',
    ItemGlobals.PRINCE_SHORT_BOOTS: 'Prince Boots',
    ItemGlobals.RAVEN_SHORT_BOOTS: 'Raven Boots',
    ItemGlobals.VOYAGER_LADY_BOOTS: 'Voyager Boots',
    ItemGlobals.MAYOR_LADY_BOOTS: 'Mayor Boots',
    ...
    ItemGlobals.GOLDEN_LARGE_EAR_LOOP_WITH_DOUBLE: 'Golden Large Loop With Double Top Ring',
    ItemGlobals.SILVER_LARGE_EAR_LOOP_WITH_DOUBLE: 'Silver Large Loop With Double Top Ring',
...
ItemFlavorText = {
    ...
    ItemGlobals.POTION_SUMMON_CHICKEN: 'Summons a mighty chicken, scares off those deathly afraid of chickens!',
    ItemGlobals.POTION_SUMMON_WASP: 'Summons an intimidating wasp, let your foes cuddle it!',
    ItemGlobals.POTION_SUMMON_DOG: 'Summons a mostly scruffy, but slightly loyal dog!' }
...
SkillDescriptions = {
    ...
    EnemySkills.MISC_FEINT: (AttackSkill, 'Auto-block one melee attack.', '', '', 0),
...
WeaponDescriptions = {
    ...
    InventoryType.PineInPocket: 'A common wood used in ship building.',
    InventoryType.OakInPocket: 'A sturdy wood used in ship building.',
    InventoryType.IronInPocket: 'A common metal used in ship building.',
    InventoryType.SteelInPocket: 'A strong metal alloy used in ship building.',
    InventoryType.CanvasInPocket: 'A common fabric used in sail contruction.',
    InventoryType.SilkInPocket: 'A rare, light-weight fabric used in sail construction.',
    InventoryType.GrogInPocket: 'Keep a weather eye out for this valuable commodity to surface soon...',
...
ShipDescriptions = {
    ...
    ItemId.HUNTER_VENGEANCE: WarshipDescription,
...
TutorialPanelDialog = {
    ...
    'teleport_tut2': 'Continents that are available for transport to are highighted. As you unlock additional continents for transport, they will become highlighted ont his map. Double click the left mouse button \x05leftClick\0x5 \x05leftClick\x05 on the highlighted continent (Tortuga) to be transported to there.',
...
TEMP_DOUBLE_REP = 'You earned a x2 reputation reward.\nYou currently have %s hours(s) and %s minute(s), before the reward expires. Type /x02 at the chat prompt to check the time remaining.'
