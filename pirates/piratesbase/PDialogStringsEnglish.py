...
DialogStringDict = {
    ...
    'rc.ghosts.fantifico.visitTiaDalma.intro': {
        0: {
            'dialog': "S\x0c3\x0ad, I see you are a worthy Pirate. So you help Se\x0c3\x0b1or Fantifico, yes?\nWe help each other, yes?\x07I have something you want. You can help me get something I need, S\x0c3\x0ad?\x07My need is simple - I merely want to...\x07LIVE AGAIN! You get me potion to live again, I help you with Ned's key. We have a deal, yes?",
            'emotes': [
                EG.EMOTE_YES,
                EG.EMOTE_SMILE,
                None,
        ...
        3: {
            ...
            'dialog': 'I am ready and willing to help, Se\x0c3\x0b1or Fantifico!',
            'emotes': [
                EG.EMOTE_YES] },
        4: {
            ...
            'emotes': [
                EG.EMOTE_YES] },
        5: {
            'dialog': "You have a keen eye for a Pirate. Yes, Se\x0c3\x0b1or Fantifico was not like the rest - I have impeccable taste and flair, as you can see!\x07But alas, my life was cut short when I was...\x01slant\x01how should I say\x02, hiding from Jolly's attack? Yes, hiding.\x07But I can restore my life with your help and then, I will speak to Se\x0c3\x0b1or Loco Ned about your honorable deeds, yes?",
            'emotes': [
                EG.EMOTE_WINK,
                None,
                EG.EMOTE_YES] } },
    'rc.ghosts.fantifico.visitTiaDalma.after': {
        0: {
            'dialog': "Se\x0c3\x0b1or Fantifico!? Ha! He was a fool and seems to be one in death, too.\x07Help you I will, but not for his sake... for yours. I want you to get the Cursed Blades of El Patron.\x07It's our only hope to stop Jolly Roger. I will brew him a special potion.",
            'emotes': [
                EG.EMOTE_LAUGH] },
        1: {
    ...
    'rc.ghosts.fantifico.PotionIngredients.after': {
        ...
        1: {
            ...
            'emotes': [
                EG.EMOTE_YES] },
        2: {
            'dialog': 'Give Se\x0c3\x0b1or Fantifico the potion and chant this,\x07\x01slant\x01Live as live and die as die, time to make the spirits fly.\x02\x07I hope for your sake it works. Now go.',
            'emotes': [] } },
    'rc.ghosts.fantifico.deliverPotion.after': {
        0: {
            'dialog': 'You have done this, s\x0c3\x0ad?! I am so happy, I dance!\x07Now give me the potion and speak the chant but be sure it is correct...\nor you may pay with your life, no?',
            'emotes': [
                EG.EMOTE_DANCE,
                EG.EMOTE_HANDITOVER] },
        1: {
        ...
        6: {
            ...
            'dialog': 'Tell Crazy Ned to give me the key because you did get your life back,...\x07...Se\x0c3\x0b1or Clucks-a-lot!',
            'emotes': [
                None,
                EG.EMOTE_LAUGH] } },
