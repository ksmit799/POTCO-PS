...
TownfolkBrushoff = [
            ...
            ("Hard for me to celebrate when I fear Jolly's return any day now!", EG.EMOTE_NO)] },
    {
        'strings': [
            ...
            ('Beef up yer ship armor before battling those Warships, mate.', None),
            ("Word of advice: upgrade your ship's hull. Pirates need plenty of room for plunder.", None),
            ("Stay ahead of Bounty Hunters an' streamline yer ship for speed!", None),
            ("What're ye waitin' for? There are new sail designs to be had!", None),
            ('Have ye customized yer ship and sails yet, mate?', None),
            ("Ship sails, hull, rigging - rumor is you can now improve 'em all.", None),
            ("Spare a doubloon? I'm looking to buy that beauty of a ship, the Brig.", None),
            ('Psst, ship upgrades are the best way to stay alive at sea.', None),
