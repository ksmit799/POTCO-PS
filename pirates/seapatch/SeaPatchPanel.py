...
class SeaPatchPanel(AppShell):
    ...
    def createInterface(self):
        ...
        geomFloaterDefs = (('Geom', 'Speed', 'Global control of wave speed', self.setOverallSpeed, 0.0, 0.0001), ('Geom', 'Radius', 'Outer Boundary at which wave will completely fade out in amplitude', self.setRadius, 0.0, 0.10000000000000001), ('Geom', 'Threshold', 'Inner Boundary at which wave will start to fade out its amplitude', self.setThreshold, 0.0, 0.10000000000000001), ('Geom', 'Height Damping', 'Damp the Bobbing for all floating objects', self.setHDamping, 0.01, 0.01), ('Geom', 'Normal Damping', 'Damp the Rocking for all floating objects', self.setNDamping, 0.01, 0.01))
        shadingFloaterDefs = (('Shading', 'Red High', 'Red Value of the High color', self.setHighColorR, 0.0, 0.10000000000000001), ('Shading', 'Blue High', 'Blue Value of the High color', self.setHighColorB, 0.0, 0.10000000000000001), ('Shading', 'Green High', 'Green Value of the High color', self.setHighColorG, 0.0, 0.10000000000000001), ('Shading', 'Alpha High', 'Alpha Value of the High color', self.setHighColorA, 0.0, 0.10000000000000001), ('Shading', 'Red Low', 'Red Value of the Low color', self.setLowColorR, 0.0, 0.10000000000000001), ('Shading', 'Blue Low', 'Blue Value of the Low color', self.setLowColorB, 0.0, 0.10000000000000001), ('Shading', 'Green Low', 'Green Value of the Low color', self.setLowColorG, 0.0, 0.10000000000000001), ('Shading', 'Alpha Low', 'Alpha Value of the Low color', self.setLowColorA, 0.0, 0.10000000000000001))
        UVFloaterDefs = (('UV', 'UScale', 'Set the U divisor for UV computation', self.setUScale, 0.10000000000000001, 0.10000000000000001), ('UV', 'VScale', 'Set the V divisor for UV computation', self.setVScale, 0.10000000000000001, 0.10000000000000001), ('UV', 'USpeed', 'The rate at which the texture slides at rest', self.setUSpeed, -100.0, 0.0001), ('UV', 'VSpeed', 'The rate at which the texture slides at rest', self.setVSpeed, -100.0, 0.0001))
