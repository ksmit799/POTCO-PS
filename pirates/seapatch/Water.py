...
class Water(DirectObject):
    ...
    all_reflections_off = classmethod(all_reflections_off)
    ...
    all_reflections_show_through_only = classmethod(all_reflections_show_through_only)
    ...
    all_reflections_on = classmethod(all_reflections_on)
