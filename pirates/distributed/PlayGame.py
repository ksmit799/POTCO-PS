...
class PlayGame(StateData.StateData):
    ...
    enterPlay = report(types = [
        'deltaStamp',
        'module',
        'args'], dConfigParam = 'teleport')(enterPlay)
    ...
    def enterTeleportToShard(self, requestStatus):
        ...
        self.acceptOnce(callbackEvent, self.fsm.request, extraArgs = [
            where,
            [
                requestStatus]])

    enterTeleportToShard = report(types = [
        'deltaStamp',
        'module',
        'args'], dConfigParam = 'teleport')(enterTeleportToShard)
